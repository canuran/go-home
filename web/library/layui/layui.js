...
;!function(d){
 ...
 var t,h=d.document,m={modules:{},status:{},timeout:10,event:{}},r=function(){
  ...
  var o=this;
  t=o.isArray(t)?t:[t], o.each(t,function(t,e){
   if(!m.status[e]) return g("module "+e+" is not exist");
   delete o[e], delete N[e], delete o.modules[e], delete m.status[e], delete m.modules[e]
  })
  ...
  var n=this,e=h.getElementsByTagName("head")[0],i=h.createElement("link"),
   t=((t="string"== typeof r?r:t)||o).replace(/\.|\//g,""),a=i.id="layuicss-"+t,u="creating",l=0;
 ...
 r.prototype.onevent=function(t,e,o){
  ...
  var n=this,i=null,a=(e||"").match(/\((.*)\)$/)||[],t=(t+"."+e).replace(a[0],""),u=a[1]||"",l=function(t,e){
...
layui.define(function(e){
 ...
 var n=document,u="getElementById",c="getElementsByTagName",a="layui-disabled",t=function(e){
  ...
  var t,i,r=this.config,n=r.groups="groups" in r?Number(r.groups)||0:5,
   ...
   s={
    ...
    page:function(){
     ...
     var a=Math.floor((n-1)/2),t=1<u?r.curr-a:1,i=1<u?(a=r.curr+(n-a-1))>r.pages?r.pages:a:n;
  ...
  if(e){
   var t=this,i=t.config,r=e.children,n=e[c]("button")[0],u=e[c]("input")[0],e=e[c]("select")[0],s=function(){
...
!function(i,r){
 ...
 var n=i.layui&&layui.define,l={
   ...
   v:"5.3.1",config:{weekStart:0},index:i.laydate&&i.laydate.v?1e5:0,path:e.laydate_dir||l.getPath,set:function(e){
    var t=this;
  ...
  },a="laydate",w="layui-this",x="laydate-disabled",h=[100,2e5],p="layui-laydate-static",M="layui-laydate-list",
  o="layui-laydate-hint",E=".laydate-btns-confirm",C="laydate-time-text",k="laydate-btns-time",
  f="layui-laydate-preview",g=function(e){
   var t=this;
   t.index= ++u.index, t.config=lay.extend({},t.config,u.config,e), (e=t.config).id="id" in e?e.id:t.index, u.ready(function(){
    t.init()
   })
 ...
 s.formatArr=function(e){
  ...
  var t,o,s=this,y=(new Date, s.config),a=s.lang(),n=y.dateTime=y.dateTime||s.systemDate(),i=s.bindElem||y.elem[0],
  ...
  return lay.each({now:a,min:n.min,max:n.max},function(e,a){
   var n;
   r[e]=l.newDate(lay.extend({year:a.year,month:a.month,date:a.date},(n={}, lay.each(i,function(e,t){
    n[t]=a[t]
   }), n))).getTime()
  ...
  var i,l,r,o=this,n=o.config,t=t?1:0,s=e||o.thisDateTime(t),y=new Date,d=o.lang(),
   m="date"!==n.type&&"datetime"!==n.type,c=lay(o.table[t]).find("td"),t=lay(o.elemHeader[t][2]).find("span");
  ...
  var i,l,e,r,o=this,s=o.config,y=s.dateTime,d=o.lang(),a=s.range&&"date"!==s.type&&"datetime"!==s.type,
   m=lay.elem("ul",{"class":M+" "+{year:"laydate-year-list",month:"laydate-month-list",time:"laydate-time-list"}[t]}),
   c=o.elemHeader[n],u=lay(c[2]).find("span"),h=o.elemCont[n||0],p=lay(h).find("."+M)[0],f="cn"===s.lang,
   g=f?"\u5e74":"",v=o.listYM[n]||{},T=["hours","minutes","seconds"],D=["startTime","endTime"][n];
  ...
  var a=this,n=a.config,i=a.thisDateTime(t),
   l=(lay(a.elem).find("td"), {year:0|(l=e.attr("lay-ymd").split("-"))[0],month:(0|l[1])-1,date:0|l[2]});
  ...
  var i=this,l=i.config,r=i.thisDateTime(n),o=l.range&&("year"===l.type||"month"===l.type),s=i.elemCont[n||0],
   y=i.listYM[n],e=function(e){
...
!function(p){
 ...
 var h,f,e,n=p.layui&&layui.define,c={
   ...
   msg:function(e,t,i){
    var n="function"== typeof t,a=c.config.skin,a=(a?a+" "+a+"-msg":"")||"layui-layer-msg",o=d.anim.length-1;
   ...
   tips:function(e,t,i){
    return m.open(h.extend({type:4,content:[e,t],closeBtn:!1,time:3e3,shade:!1,resize:!1,fixed:!1,maxWidth:260},i))
   }
  },t=function(e){
  ...
  i=(d.anim=["layer-anim-00","layer-anim-01","layer-anim-02","layer-anim-03","layer-anim-04","layer-anim-05","layer-anim-06"], d.SHADE="layui-layer-shade", d.MOVE="layui-layer-move", t.pt.config={
   ...
   var i=this.index,n=this.config,a=n.zIndex+i,o="object"== typeof n.title,s=n.maxmin&&(1===n.type||2===n.type),
   ...
   var e=this.config,t=this.layero,i=[t.outerWidth(),t.outerHeight()],n=h(e.follow),
   ...
   e.tips[1]||o.remove(), a.autoLeft=function(){
    0<a.left+i[0]-f.width()?(a.tipLeft=a.left+a.width-i[0], o.css({right:12,left:"auto"})):a.tipLeft=a.left
   }, a.where=[function(){
   ...
   var o=this,s=o.config,e=h(document),r=o.layero,t=r.find(s.move),i=r.find(".layui-layer-resize"),l={};
   ...
   var e=h("#"+d[0]+e),n=e.find(".layui-layer-content"),a=e.attr("type"),o=e.find(d[1]).outerHeight()||0,
   ...
   t=t||{};
   var i=h("#"+d[0]+e),n=h("#"+d.SHADE+e),a=i.find(d[1]).outerHeight()||0,o=i.attr("minLeft")||181*c.minIndex+"px",
    s=i.css("position"),r={width:180,height:a,position:"fixed",overflow:"hidden"};
 ...
 m.prompt=function(i,n){
  ...
  var a={};
  if((i=i||{}).photos){
   var t=!("string"== typeof i.photos||i.photos instanceof h),o=t?i.photos:{},s=o.data||[],r=o.start||0,
...
layui.define("jquery",function(e){
 ...
 var u=layui.$,a=layui.hint(),o={
  fixbar:function(t){
   ...
   var n=this,o="function"== typeof t,a=new Date(e).getTime(),r=new Date(!t||o?(new Date).getTime():t).getTime(),a=a-r,
...
layui.define(["jquery","laytpl","lay"],function(e){
 "use strict";
 var n,i,t,s=layui.$,m=layui.laytpl,a=layui.hint(),l=layui.device().mobile?"click":"mousedown",o="dropdown",
  r="layui_"+o+"_index",c={
  ...
  g="layui-menu-item-parent",h="layui-menu-item-checked",v="layui-menu-item-checked2",w="layui-menu-body-panel",
  C="layui-menu-body-panel-left",V="."+f+">."+y,k=function(e){
   var i=this;
 ...
 k.prototype.config={
  ...
  var i=s(this),t=i.parents(".layui-menu").eq(0),n=i.hasClass(f)||i.hasClass(g),a=t.attr("lay-filter")||t.attr("id"),
   l=lay.options(this);
  ...
  t[0]&&((i=t[0].getBoundingClientRect()).right>n.width()&&(t.addClass(C), (i=t[0].getBoundingClientRect()).left<0&&t.removeClass(C)), i.bottom>n.height()&&t.eq(0).css("margin-top",-(i.bottom-n.height())))
...
layui.define("jquery",function(e){
 ...
 i.prototype.config={
  ...
  var r=this.config,o=this.elemTemp,u=function(){
   ...
   m=100/((r.max-r.min)/Math.ceil(r.step)),v=function(e,i){
    e=100<(e=100<Math.ceil(e)*m?Math.ceil(e)*m:Math.round(e)*m)?100:e, d.eq(i).css("vertical"===r.type?"bottom":"left",e+"%");
    var t,a=p(d[0].offsetLeft),n=r.range?p(d[1].offsetLeft):0,l=("vertical"===r.type?(o.find("."+x).css({
      bottom:e+"%",
      "margin-bottom":"20px"
     }), a=p(u()-d[0].offsetTop-d.height()), n=r.range?p(u()-d[1].offsetTop-d.height()):0):o.find("."+x).css("left",e+"%"), a=100<a?100:a, n=100<n?100:n, Math.min(a,n)),
     a=Math.abs(a-n),n=("vertical"===r.type?o.find("."+y).css({height:a+"%",bottom:l+"%"}):o.find("."+y).css({
      width:a+"%",
      left:l+"%"
  ...
  o.find("."+b).each(function(l){
   ...
   s.on("mousedown",function(e){
    ...
    e=function(e){
     e=e||window.event;
     var i=a+("vertical"===r.type?n-e.clientY:e.clientX-n),i=(i=(i=i<0?0:i)>u()?u():i)/u()*100/m;
  ...
  var a=function(){
   var e=this.value,e=(e=(e=(e=isNaN(e)?0:e)<r.min?r.min:e)>r.max?r.max:e, ((this.value=e)-r.min)/(r.max-r.min)*100/m);
   v(e,0)
  };
...
layui.define(["jquery","lay"],function(e){
 ...
 c.prototype.config={
  ...
  var e,i=this,o=(i.config, i.elemColorBox.find("."+P)),r=i.elemPicker.find("."+F),n=o[0].style.backgroundColor;
  ...
  var n=this,l=n.config,t=n.elemColorBox.find("."+P),c=t.attr("lay-type"),
   a=n.elemPicker.find(".layui-colorpicker-side"),e=n.elemPicker.find("."+B),s=n.elemPicker.find("."+w),
   r=n.elemPicker.find("."+E),d=n.elemPicker.find("."+D),f=n.elemPicker.find("."+j),u=e[0].offsetTop/180*360,
   p=100-(r[0].offsetTop+3)/180*100,g=(r[0].offsetLeft+3)/260*100,h=Math.round(f[0].offsetLeft/280*100)/100,
   v=n.elemColorBox.find("."+C),i=n.elemPicker.find(".layui-colorpicker-pre").children("div"),b=function(e,i,o,r){
    n.select(e,i,o);
    e=M({h:e,s:i,b:o});
   ...
   },o=y(['<div class="layui-auxiliar-moving" id="LAY-colorpicker-moving"></div>'].join("")),k=function(e){
  ...
  e.on("mousedown",function(e){
   ...
   k(function(e){
    var i=r+(e.clientY-n),o=a[0].offsetHeight,o=(i=o<(i=i<0?0:i)?o:i)/180*360;
    b(u=o,g,p,h), e.preventDefault()
   }), e.preventDefault()
  }), a.on("click",function(e){
   var i=e.clientY-y(this).offset().top,i=(i=(i=i<0?0:i)>this.offsetHeight?this.offsetHeight:i)/180*360;
   ...
   layui.stope(e), k(function(e){
    var i=l+(e.clientY-c),o=t+(e.clientX-a),r=s[0].offsetHeight-3,n=s[0].offsetWidth-3,
     n=((o=n<(o=o< -3?-3:o)?n:o)+3)/260*100,o=100-((i=r<(i=i< -3?-3:i)?r:i)+3)/180*100;
    b(u,g=n,p=o,h), e.preventDefault()
   }), e.preventDefault()
  }), s.on("mousedown",function(e){
   var i=e.clientY-y(this).offset().top-3+I.scrollTop(),o=e.clientX-y(this).offset().left-3+I.scrollLeft(),
   ...
   k(function(e){
    var i=r+(e.clientX-n),o=d[0].offsetWidth,o=(o<(i=i<0?0:i)&&(i=o), Math.round(i/280*100)/100);
  ...
  var n=this,l=(n.config, f({h:e,s:100,b:100})),t=f({h:e,s:i,b:o}),e=e/360*180,o=180-o/100*180-3,i=i/100*260-3;
...
layui.define("jquery",function(t){
 "use strict";
 var u=layui.$,d=(layui.hint(), layui.device()),c="element",r="layui-this",y="layui-show",i=function(){
   this.config={}
   ...
   var a,t=u(".layui-tab[lay-filter="+t+"]"),e=t.children(".layui-tab-title"),l=e.children(".layui-tab-bar"),
  ...
  m="layui-anim layui-anim-upbit",C={
   tabClick:function(t,i,a,e){
    e=e||{};
    var a=a||u(this),i=i||a.parent().children("li").index(a),l=e.headerElem?a.parent():a.parents(".layui-tab").eq(0),
     e=e.bodyElem?u(e.bodyElem):l.children(".layui-tab-content").children(".layui-tab-item"),n=a.find("a"),
     n="javascript:;"!==n.attr("href")&&"_blank"===n.attr("target"),s="string"== typeof a.attr("lay-unselect"),
     o=l.attr("lay-filter");
...
layui.define("layer",function(e){
 ...
 },n="upload",o="layui-upload-file",a="layui-upload-form",F="layui-upload-iframe",b="layui-upload-choose",x=function(e){
  var t=this;
 ...
 x.prototype.config={
  ...
  var i,e=this.config,t=v('<iframe id="'+F+'" class="'+F+'" name="'+F+'" frameborder="0"></iframe>'),
  ...
  var n,o,t,a,l=this,r=l.config,u=l.elemFile[0],c=function(){
    var t=0,o=0,e=i||l.files||l.chooseFiles||u.files,a=function(){
     r.multiple&&t+o===l.fileLength&&"function"== typeof r.allDone&&r.allDone({total:l.fileLength,successful:t,failed:o})
    };
...
layui.define("layer",function(e){
 "use strict";
 var C=layui.$,f=layui.layer,l=layui.hint(),w=(layui.device(), "form"),s=".layui-form",T="layui-this",$="layui-hide",
  E="layui-disabled",t=function(){
   this.config={
    verify:{
     required:[/[\S]+/,"\u5fc5\u586b\u9879\u4e0d\u80fd\u4e3a\u7a7a"],
   ...
   var i=this.config,a=C(s+(t?'[lay-filter="'+t+'"]':"")),n={
    input:function(e){
     ...
     var p,c="\u8bf7\u9009\u62e9",m="layui-form-select",g="layui-select-title",k="layui-select-none",x="",
      e=e||a.find("select"),b=function(e,t){
       C(e.target).parent().hasClass(g)&& !t||(C("."+m).removeClass(m+"ed "+m+"up"), p&&x&&p.val(x)), p=null
      },u=function(a,e,t){
       var o,r,i,n,s,l,c=C(this),u=a.find("."+g),d=u.find("input"),f=a.find("dl"),h=f.children("dd"),y=f.children("dt"),
       ...
       e||(r=c.attr("lay-search"), i=function(){
        ...
        var l=0,t=(layui.each(h,function(){
         var e=C(this),t=e.text(),i=("exact"!==r&&(t=t.toLowerCase(), a=a.toLowerCase()), -1===t.indexOf(a));
     ...
     e.each(function(e,t){
      var i=C(this),a=i.next("."+m),n=this.disabled,l=t.value,r=C(t.options[t.selectedIndex]),t=t.options[0];
     ...
     e.each(function(e,t){
      var i=C(this),a=i.attr("lay-skin"),n=(i.attr("lay-text")||"").split("|"),l=this.disabled,
   ...
   var c=null,u=r.config.verify,d="layui-form-danger";
   return !(e=C(e))[0]||(e.attr("lay-verify")||(e=e.find("*[lay-verify]")), layui.each(e,function(e,l){
    var r=C(this),t=(r.attr("lay-verify")||"").split("|"),o=r.attr("lay-verType"),s=r.val();
    if(r.removeClass(d), layui.each(t,function(e,t){
     var i="",a="function"== typeof u[t];
     if(u[t]){
      var a=a?i=u[t](s,l):!u[t][0].test(s),n="select"===l.tagName.toLowerCase()||/^checkbox|radio$/.test(l.type),
       i=i||u[t][1];
      if("required"===t&&(i=r.attr("lay-reqText")||i), a) return "tips"===o?f.tips(i,"string"!= typeof r.attr("lay-ignore")&&n?r.next():r,{tips:1}):"alert"===o?f.alert(i,{
       title:"\u63d0\u793a",
       shadeClose:!0
      }):/\bstring|number\b/.test(typeof i)&&f.msg(i,{icon:5,shift:6}), setTimeout(function(){
   ...
   var i=C(this),e="string"== typeof e?e:i.attr("lay-filter"),a=this.getFormElem?this.getFormElem(e):i.parents(s).eq(0),
    n=a.find("*[lay-verify]");
...
layui.define(["laytpl","laypage","layer","form","util"],function(e){
 "use strict";
 var p=layui.$,m=layui.laytpl,d=layui.laypage,v=layui.layer,h=layui.form,f=layui.util,g=layui.hint(),b=layui.device(),
  x={
   ...
   return t&&(i="function"== typeof t?t.call(a,e.tplData,e.obj):m(p(t).html()||String(i)).render(e.tplData)), e.text?p("<div>"+i+"</div>").text():i
  },C="table",w="layui-hide",c="layui-hide-v",r="layui-none",o="layui-table-view",s=".layui-table-header",
  T=".layui-table-body",N=".layui-table-sort",L="layui-table-edit",D="layui-table-hover",t=function(e){
  ...
  S=p(window),F=p(document),i=function(e){
   ...
   a.height&&/^full-\d+$/.test(a.height)&&(t.fullHeightGap=a.height.split("-")[1], a.height=S.height()-t.fullHeightGap), t.setInit();
   var i,e=a.elem,l=e.next("."+o),n=t.elem=p('<div class="layui-form layui-border-box"></div>');
   n.addClass((i=[o,o+"-"+t.index], a.className&&i.push(a.className), i.join(" "))).attr({
   ...
   c.css&& -1===c.css.indexOf(o)&&(a=c.css.split("}"), layui.each(a,function(e,t){
    t&&(a[e]="."+o+"-"+d.index+" "+t)
   }), c.css=a.join("}"));
   var r=function(a,e,i,l){
    var n,o;
    l?(l.key=a+"-"+i, l.hide=l.hide|| !1, l.colspan=l.colspan||1, l.rowspan=l.rowspan||1, d.initOpts(l), (n=a+(parseInt(l.rowspan)||1))<c.cols.length?(l.colGroup= !0, o=0, layui.each(c.cols[n],function(e,t){
     t.HAS_PARENT||1<=o&&o==(l.colspan||1)||(t.HAS_PARENT= !0, t.parentKey=a+"-"+i, o+=parseInt(1<t.colspan?t.colspan:1), r(n,c.cols[n],e,t))
   ...
   var a=this.config,i=this.layHeader.find('th[data-key="'+a.index+"-"+t+'"]'),l=parseInt(i.attr("colspan"))||0;
   ...
   var t,a,i=this,o=i.config,l=0,d=0,c=0,r=0,s=i.setInit("width"),e=(i.eachCols(function(e,t){
    t.hide||l++
    ...
    layui.each(o.cols,function(e,l){
     layui.each(l,function(e,t){
      ...
      t?t.colGroup||t.hide||(n?c&&c<i&&(d--, a=i):(a=t.width||0, /\d+%$/.test(a)?(a=Math.floor(parseFloat(a)/100*s))<i&&(a=i):a||(t.width=a=0, d++)), t.hide&&(a=0), r+=a):l.splice(e,1)
     })
    }), r<s&&d&&(c=(s-r)/d)
   ...
   var t=this,a=t.layMain.find("."+r),e=p('<div class="'+r+'">'+(e||"Error")+"</div>");
   a[0]&&(t.layNone.remove(), a.remove()), t.layFixed.addClass(w), t.layMain.find("tbody").html(""), t.layMain.append(t.layNone=e), t.layPage&&t.layPage.addClass(c).find(">div").html(""), t.layTotal&&t.layTotal.addClass(c).find("tbody").html(""), x.cache[t.key]=[]
  }, i.prototype.page=1, i.prototype.pullData=function(t){
   var e,a=this,i=a.config,l=i.request,n=i.response,o=function(){
    "object"== typeof i.initSort&&a.sort(i.initSort.field,i.initSort.type)
   };
   a.startTime=(new Date).getTime(), i.url?((e={})[l.pageName]=t, e[l.limitName]=i.limit, l=p.extend(e,i.where), i.contentType&&0==i.contentType.indexOf("application/json")&&(l=JSON.stringify(l)), a.loading(), p.ajax({
    type:i.method||"get",
    url:i.url,
    ...
    headers:i.headers||{},
    success:function(e){
     (e="function"== typeof i.parseData?i.parseData(e)||e:e)[n.statusName]!=n.statusCode?(a.renderForm(), a.errorView(e[n.msgName]||'\u8fd4\u56de\u7684\u6570\u636e\u4e0d\u7b26\u5408\u89c4\u8303\uff0c\u6b63\u786e\u7684\u6210\u529f\u72b6\u6001\u7801\u5e94\u4e3a\uff1a"'+n.statusName+'": '+n.statusCode)):(a.renderData(e,t,e[n.countName]), o(), i.time=(new Date).getTime()-a.startTime+" ms"), a.setColsWidth(), "function"== typeof i.done&&i.done(e,t,e[n.countName])
    },
    error:function(e,t){
     a.errorView("\u8bf7\u6c42\u5f02\u5e38\uff0c\u9519\u8bef\u63d0\u793a\uff1a"+t), a.renderForm(), a.setColsWidth(), "function"== typeof i.error&&i.error(e,t)
    }
   })):"array"===layui.type(i.data)&&(e=t*i.limit-i.limit, (l={})[n.dataName]=i.data.concat().splice(e,i.limit), l[n.countName]=i.data.length, "object"== typeof i.totalRow&&(l[n.totalRowName]=p.extend({},i.totalRow)), a.renderData(l,t,l[n.countName]), o(), a.setColsWidth(), "function"== typeof i.done&&i.done(l,t,l[n.countName]))
  }, i.prototype.eachCols=function(e){
   return x.eachCols(null,e,this.config.cols), this
  }, i.prototype.renderData=function(e,t,a,l){
   var u=this,y=u.config,i=e[y.response.dataName]||[],e=e[y.response.totalRowName],n=[],h=[],f=[],o=function(){
    var s;
    if(!l&&u.sortKey) return u.sort(u.sortKey.field,u.sortKey.sort,!0);
    layui.each(i,function(o,d){
     var a=[],i=[],c=[],r=o+y.limit*(t-1)+1;
     "array"===layui.type(d)&&0===d.length||(l||(d[x.config.indexName]=o), u.eachCols(function(e,l){
      var e=l.field||e,t=y.index+"-"+l.key,n=d[e];
      n!==undefined&&null!==n||(n=""), l.colGroup||(t=['<td data-field="'+e+'" data-key="'+t+'" '+(e=[], l.edit&&e.push('data-edit="'+l.edit+'"'), l.templet&&e.push('data-content="'+n+'"'), l.toolbar&&e.push('data-off="true"'), l.event&&e.push('lay-event="'+l.event+'"'), l.minWidth&&e.push('data-minwidth="'+l.minWidth+'"'), e.join(" "))+' class="'+(e=[], l.hide&&e.push(w), l.field||e.push("layui-table-col-special"), e.join(" "))+'">','<div class="layui-table-cell laytable-cell-'+("normal"===l.type?t:t+" laytable-cell-"+l.type)+'"'+(l.align?' align="'+l.align+'"':"")+(e=[], l.style&&e.push('style="'+l.style+'"'), e.join(" "))+">"+function(){
       var e,t=p.extend(!0,{LAY_INDEX:r,LAY_COL:l},d),a=x.config.checkName,i=x.config.disabledName;
       switch(l.type){
        case"checkbox":
       ...
       return l.toolbar?m(p(l.toolbar).html()||"").render(t):k.call(u,{item3:l,content:n,tplData:t})
      }(),"</div></td>"].join(""), a.push(t), l.fixed&&"right"!==l.fixed&&i.push(t), "right"===l.fixed&&c.push(t))
     }), n.push('<tr data-index="'+o+'">'+a.join("")+"</tr>"), h.push('<tr data-index="'+o+'">'+i.join("")+"</tr>"), f.push('<tr data-index="'+o+'">'+c.join("")+"</tr>"))
    }), u.layBody.scrollTop(0), y.resetScrollbar&&u.layBody.scrollLeft(0), u.layMain.find("."+r).remove(), u.layMain.find("tbody").html(n.join("")), u.layFixLeft.find("tbody").html(h.join("")), u.layFixRight.find("tbody").html(f.join("")), u.renderForm(), "number"== typeof s&&u.setThisRowChecked(s), u.syncCheckAll(), u.haveInit?u.scrollPatch():setTimeout(function(){
     u.scrollPatch()
    },50), u.haveInit= !0, v.close(u.tipsIndex), y.HAS_SET_COLS_PATCH||u.setColsPatch(), y.HAS_SET_COLS_PATCH= !0
   };
   return x.cache[u.key]=i, u.layTotal[0==i.length?"addClass":"removeClass"](c), y.pagebar||u.layPage[0==a||0===i.length&&1==t?"addClass":"removeClass"](c), 0===i.length?(u.renderForm(), u.errorView(y.text.none)):(u.layFixed.removeClass(w), l?o():(o(), u.renderTotal(i,e), u.layTotal&&u.layTotal.removeClass(w), void (y.page&&(y.page=p.extend({
   ...
   var i,n=this,o={},d=n.config,c=d.elem.attr("lay-filter"),r=x.cache[n.key];
   ...
   n.sortKey={
    field:s,
    sort:e
   }, d.autoSort&&("asc"===e?i=layui.sort(r,s):"desc"===e?i=layui.sort(r,s,!0):(i=layui.sort(r,x.config.indexName), delete n.sortKey)), o[d.response.dataName]=i||r, n.renderData(o,n.page,n.count,!0), a&&(d.initSort={
    field:s,
    type:e
   }, layui.event.call(l,C,"sort("+c+")",d.initSort))
   ...
   e.fullHeightGap&&(a=S.height()-e.fullHeightGap, e.elem.css("height",a=a<135?135:a)), a&&(a=parseFloat(a)-(e.layHeader.outerHeight()||38), t.toolbar&&(a-=e.layTool.outerHeight()||50), t.totalRow&&(a-=e.layTotal.outerHeight()||40), t.page&&(a-=e.layPage.outerHeight()||41), e.layMain.css("height",a-2))
   ...
   var l,r=this,c=r.config,i=p("body"),n={},e=r.layHeader.find("th"),s=".layui-table-cell",u=c.elem.attr("lay-filter"),
    o=(r.layTool.on("click","*[lay-event]",function(e){
     var a,i=p(this),t=i.attr("lay-event"),l=function(e){
      var t=p(e.list),a=p('<ul class="layui-table-tool-panel"></ul>');
      a.html(t), c.height&&a.css("max-height",c.height-(r.layTool.outerHeight()||50)), i.find(".layui-table-tool-panel")[0]||i.append(a), r.renderForm(), a.on("click",function(e){
       layui.stope(e)
      }), e.done&&e.done(a,t)
     };
     switch(layui.stope(e), F.trigger("table.tool.panel.remove"), v.close(r.tipsIndex), t){
      case"LAYTABLE_COLS":
       l({
        list:(a=[], r.eachCols(function(e,t){
         ...
         h.on("checkbox(LAY_TABLE_TOOL_COLS)",function(e){
          var e=p(e.elem),i=this.checked,l=e.data("key"),n=e.data("parentkey");
          layui.each(c.cols,function(a,e){
           layui.each(e,function(e,t){
            a+"-"+e===l&&(e=t.hide, t.hide= !i, r.elem.find('*[data-key="'+c.index+"-"+l+'"]')[i?"removeClass":"addClass"](w), e!=t.hide&&r.setParentCol(!i,n), r.resize())
           })
          })
         })
        }
     ...
     layui.event.call(this,C,"toolbar("+u+")",p.extend({event:t,config:c},{}))
    }), r.layPagebar.on("click","*[lay-event]",function(e){
     var t=p(this).attr("lay-event");
     layui.event.call(this,C,"pagebar("+u+")",p.extend({event:t,config:c},{}))
    }), e.on("mousemove",function(e){
     ...
     var t,a=p(this);
     n.allowResize&&(t=a.data("key"), e.preventDefault(), n.resizeStart= !0, n.offset=[e.clientX,e.clientY], r.getCssRule(t,function(e){
      var t=e.style.width||a.outerWidth();
      n.rule=e, n.ruleWidth=parseFloat(t), n.minWidth=a.data("minwidth")||c.cellMinWidth
     }))
    }), F.on("mousemove",function(e){
     n.resizeStart&&(e.preventDefault(), n.rule&&((e=n.ruleWidth+e.clientX-n.offset[0])<n.minWidth&&(e=n.minWidth), n.rule.style.width=e+"px", v.close(r.tipsIndex)), l=1)
    }).on("mouseup",function(e){
     n.resizeStart&&(n={}, i.css("cursor",""), r.scrollPatch()), 2===l&&(l=null)
    }), e.on("click",function(e){
     var t=p(this),a=t.find(N),i=a.attr("lay-sort");
     if(!a[0]||1===l) return l=2;
     r.sort(t,"asc"===i?"desc":"desc"===i?null:"asc",null,!0)
    }).find(N+" .layui-edge ").on("click",function(e){
     var t=p(this),a=t.index(),t=t.parents("th").eq(0).data("field");
     layui.stope(e), 0===a?r.sort(t,"asc",null,!0):r.sort(t,"desc",null,!0)
    }), r.commonMember=function(e){
     var t=p(this).parents("tr").eq(0).data("index"),d=r.layBody.find('tr[data-index="'+t+'"]'),
      c=(c=x.cache[r.key]||[])[t]||{};
     return p.extend({
      tr:d,data:x.clearCacheKey(c),del:function(){
       x.cache[r.key][t]=[], d.remove(), r.scrollPatch()
      },update:function(e){
       e=e||{}, layui.each(e,function(i,l){
        var n=d.children('td[data-field="'+i+'"]'),o=n.children(s);
        i in c&&(c[i]=l), r.eachCols(function(e,t){
         var a;
         t.field==i?(o.html(k.call(r,{
          item3:t,
          content:l,
          tplData:c
         })), n.data("content",l), t.templet&&r.renderForm()):(t.templet||t.toolbar)&&(e=d.children('td[data-field="'+(t.field||e)+'"]'), a=c[t.field], e.children(s).html(k.call(r,{
          item3:t,
          content:a,
          tplData:c
         })), e.data("content",a), r.renderForm())
        })
       })
      }
     },e)
    }),t=(r.elem.on("click",'input[name="layTableCheckbox"]+',function(){
     var e=p(this).prev(),t=r.layBody.find('input[name="layTableCheckbox"]'),a=e.parents("tr").eq(0).data("index"),
      i=e[0].checked,l="layTableAllChoose"===e.attr("lay-filter");
     e[0].disabled||(l?(t.each(function(e,t){
      t.checked=i, r.setCheckData(e,i)
     }), r.syncCheckAll(), r.renderForm("checkbox")):(r.setCheckData(a,i), r.syncCheckAll()), layui.event.call(e[0],C,"checkbox("+u+")",o.call(e[0],{
      checked:i,
      type:l?"all":"one"
     })))
    }), r.elem.on("click",'input[lay-type="layTableRadio"]+',function(){
     var e=p(this).prev(),t=e[0].checked,a=x.cache[r.key],i=e.parents("tr").eq(0).data("index");
     layui.each(a,function(e,t){
      i===e?t[c.checkName]= !0:delete t[c.checkName]
     }), r.setThisRowChecked(i), layui.event.call(this,C,"radio("+u+")",o.call(this,{checked:t}))
    }), r.layBody.on("mouseenter","tr",function(){
     var e=p(this),t=e.index();
     e.data("off")||r.layBody.find("tr:eq("+t+")").addClass(D)
    }).on("mouseleave","tr",function(){
     var e=p(this),t=e.index();
     e.data("off")||r.layBody.find("tr:eq("+t+")").removeClass(D)
     ...
     var e=p(this),t=this.value,a=e.parent().data("field"),e=e.parents("tr").eq(0).data("index");
     x.cache[r.key][e][a]=t, layui.event.call(this,C,"edit("+u+")",o.call(this,{value:t,field:a}))
    }).on("blur","."+L,function(){
     var a,e,t=p(this),i=t.parent().data("field"),l=t.parents("tr").eq(0).data("index"),l=x.cache[r.key][l];
     r.eachCols(function(e,t){
      t.field==i&&t.templet&&(a=t)
     }), t.siblings(s).html((e=this.value, k.call(r,{
      item3:a||{},
      content:e,
      tplData:l
     }))), t.parent().data("content",this.value), t.remove()
    }), r.layBody.on(c.editTrigger,"td",function(e){
     var t=p(this),a=(t.data("field"), t.data("edit")),i=t.children(s);
     t.data("off")||a&&((a=p("textarea"===a?'<textarea class="layui-input '+L+'"></textarea>':'<input class="layui-input '+L+'">'))[0].value=t.data("content")||i.text(), t.find("."+L)[0]||t.append(a), a.focus(), layui.stope(e))
    }).on("mouseenter","td",function(){
     a.call(this)
    }).on("mouseleave","td",function(){
     a.call(this,"hide")
    }), "layui-table-grid-down"),a=function(e){
     var t=p(this),a=t.children(s);
     t.data("off")||(e?t.find(".layui-table-grid-down").remove():!(a.prop("scrollWidth")>a.outerWidth()||0<a.find("br").length)||c.lineStyle||a.find("."+d)[0]||t.append('<div class="'+d+'"><i class="layui-icon layui-icon-down"></i></div>'))
    },y=(r.layBody.on("click","."+d,function(e){
     var t=p(this).parent().children(s);
     r.tipsIndex=v.tips(['<div class="layui-table-tips-main" style="margin-top: -'+(t.height()+23)+"px;"+("sm"===c.size?"padding: 4px 15px; font-size: 12px;":"lg"===c.size?"padding: 14px 15px;":"")+'">',t.html(),"</div>",'<i class="layui-icon layui-table-tips-c layui-icon-close"></i>'].join(""),t[0],{
      tips:[3,""],
      time:-1,
      anim:-1,
      maxWidth:b.ios||b.android?300:r.elem.width()/2,
      isOutAnim:!1,
     ...
     layui.event.call(this,C,(e||"tool")+"("+u+")",o.call(this,{event:t.attr("lay-event")})), r.setThisRowChecked(a)
    });
   r.layBody.on("click","*[lay-event]",function(){
    ...
    r.layHeader.scrollLeft(t), r.layTotal.scrollLeft(t), r.layFixed.find(T).scrollTop(e), v.close(r.tipsIndex)
   ...
   p(".layui-table-tool-panel").remove()
  }), x.init=function(a,i){
   i=i||{};
   ...
   return e.each(function(){
    var e=p(this),t=e.attr("lay-data");
    try{
    ...
    a&&e.hide(), e.find("thead>tr").each(function(i){
     o.cols[i]=[], p(this).children().each(function(e){
      ...
      t=p.extend({title:t.text(),colspan:t.attr("colspan")||1,rowspan:t.attr("rowspan")||1},a);
   ...
   l.colGroup&&(n=0, a++, l.CHILD_COLS=[], o=e+(parseInt(l.rowspan)||1), layui.each(i[o],function(e,t){
    t.PARENT_COL_INDEX||1<=n&&n==(l.colspan||1)||(t.PARENT_COL_INDEX=a, l.CHILD_COLS.push(t), n+=t.hide?0:parseInt(1<t.colspan?t.colspan:1), R(a,i,o,t))
   }))
  });
 x.eachCols=function(e,a,i){
  var e=y.config[e]||{},l=[],n=(i=p.extend(!0,[],i||e.cols), layui.each(i,function(a,e){
   if(a) return !0;
   layui.each(e,function(e,t){
    R(0,i,a,t), t.PARENT_COL_INDEX||l.push(t)
   })
  }), function(e){
  ...
  var d,i,l,c,n=(a="object"== typeof a?a:(n={}, a&&(n.type=a), n)).type||"csv",r=y.that[e],o=y.config[e]||{},
   s={csv:"text/csv",xls:"application/vnd.ms-excel"}[n],u=document.createElement("a");
  if(b.ie) return g.error("IE_NOT_SUPPORT_EXPORTS");
  u.href="data:"+s+";charset=utf-8,\ufeff"+encodeURIComponent((d=[], i=[], l=[], c={}, layui.each(t,function(l,n){
   var o=[];
   "object"== typeof e?(layui.each(e,function(e,t){
    ...
    var a,i;
    t.field&&"normal"==t.type&&(t.hide?0==l&&(c[t.field]= !0):(a=n[t.field], i=r.layBody.find('tr[data-index="'+l+'"]>td'), a!==undefined&&null!==a||(a=""), 0==l&&d.push(t.title||""), o.push('"'+k.call(r,{
     item3:t,
     content:a,
     tplData:n,
     text:"text",
     obj:r.commonMember.call(i.eq(0),{
      td:function(e){
  ...
  var a=p.extend([],arguments),
   i=(a[3]="reloadData", new RegExp("^("+["data","url","where","page","limit","request","response","parseData"].join("|")+")$"));
...
layui.define("jquery",function(e){
 ...
 var a=layui.$,n=(layui.hint(), layui.device(), {
  ...
  }),d="carousel",r="layui-this",s="layui-carousel-left",u="layui-carousel-right",c="layui-carousel-prev",
  m="layui-carousel-next",t="layui-carousel-arrow",l="layui-carousel-ind",i=function(e){
   var i=this;
 ...
 i.prototype.config={
  ...
  var i,n=this,t=n.config,e=n.elemInd=a(['<div class="'+l+'"><ul>',(i=[], layui.each(n.elemItem,function(e){
...
layui.define(["layer","form"],function(t){
 "use strict";
 var u=layui.$,c=layui.layer,a=layui.form,d=(layui.hint(), layui.device()),i="layedit",y="layui-disabled",e=function(){
  ...
  e=e||{};
  var i,l,a=this,n=a.config,o="layui-layedit",s=u("string"== typeof t?"#"+t:t),r="LAY_layedit_"+ ++a.index,
   c=s.next("."+o),n=u.extend({},n,e),e=(i=[], l={}, layui.each(n.hideTool,function(t,e){
    l[e]= !0
...
layui.define(["util"],function(l){
 "use strict";
 var t=layui.$,n=layui.util;
 l("code",function(i){
  var l=[];
  (i=i||{}).elem=t(i.elem||".layui-code"), i.lang="lang" in i?i.lang:"code", i.elem.each(function(){
   l.push(this)
  }), layui.each(l.reverse(),function(l,a){
   var a=t(a),e=(e=a.html(), t.trim(e).replace(/^\n|\n$/,"")),
   ...
   a.addClass("layui-box layui-code-view"), (a.attr("lay-skin")||i.skin)&&a.addClass("layui-code-"+(a.attr("lay-skin")||i.skin)), 0<(e.find("li").length/100|0)&&e.css("margin-left",(e.find("li").length/100|0)+"px"), (a.attr("lay-height")||i.height)&&e.css("max-height",a.attr("lay-height")||i.height)
  })
 })
