!function(t,e){
 ...
 function e(t){
  ...
  return n&&(i.firefox= !0, i.version=n[1]), r&&(i.ie= !0, i.version=r[1]), a&&(i.edge= !0, i.version=a[1]), o&&(i.weChat= !0), {
   browser:i,os:e,node:!1,canvasSupported:!!document.createElement("canvas").getContext,svgSupported:"undefined"!= typeof SVGRect,touchEventsSupported:"ontouchstart" in window&& !i.ie&& !i.edge,pointerEventsSupported:"onpointerdown" in window&&(i.edge||i.ie&&i.version>=11),domSupported:"undefined"!= typeof document
  }
 }
 function i(t,e){
 ...
 function ye(t,e,i){
  return {
   type:t,event:i,target:e.target,topTarget:e.topTarget,cancelBubble:!1,offsetX:i.zrX,offsetY:i.zrY,gestureEvent:i.gestureEvent,pinchX:i.pinchX,pinchY:i.pinchY,pinchScale:i.pinchScale,wheelDelta:i.zrDelta,zrByTouch:i.zrByTouch,which:i.which,stop:xe
  }
 }
 function xe(){
  Ig(this.event)
 ...
 function Ze(t,e){
  var i=(parseFloat(t[0])%360+360)%360/360,n=Be(t[1]),r=Be(t[2]),a=.5>=r?r*(n+1):r+n-r*n,o=2*r-a;
 ...
 function Ue(t,e,i){
  if(e&&e.length&&t>=0&&1>=t){
   var n=t*(e.length-1),r=Math.floor(n),a=Math.ceil(n),o=He(e[r]),s=He(e[a]),l=n-r,h=Qe([Oe(Fe(o[0],s[0],l)),Oe(Fe(o[1],s[1],l)),Oe(Fe(o[2],s[2],l)),Ee(Fe(o[3],s[3],l))],"rgba");
 ...
 function Bi(t,e,i,n,r,a,o){
  var s=qi(t,{rich:a,truncate:o,font:e,textAlign:i,textPadding:r}),l=s.outerWidth,h=s.outerHeight,u=Ni(0,l,i),c=Fi(0,h,n);
 ...
 function qi(t,e){
  ...
  for(var p=0; p<o.length; p++){
   for(var g=o[p],v=0,m=0,y=0; y<g.tokens.length; y++){
    var x=g.tokens[y],_=x.styleName&&e.rich[x.styleName]||{},w=x.textPadding=_.textPadding,b=x.font=_.font||e.font,S=x.textHeight=D(_.textHeight,Xi(b));
 ...
 function en(t,e,i,n,r,a){
  ...
  var d=c.outerHeight,f=c.lines,p=c.lineHeight,g=un(d,n,r),v=g.baseX,m=g.baseY,y=g.textAlign||"left",x=g.textVerticalAlign;
  an(e,n,r,v,m);
  ...
  b+=p/2;
  var L=n.textStrokeWidth,O=s?o.textStrokeWidth:null,z=!s||L!==O,E=!s||z||n.textStroke!==o.textStroke,R=dn(n.textStroke,L),B=fn(n.textFill);
 ...
 function rn(t,e,i,n,r){
  var a=i.width,o=i.outerWidth,s=i.outerHeight,l=n.textPadding,h=un(s,n,r),u=h.baseX,c=h.baseY,d=h.textAlign,f=h.textVerticalAlign;
  an(e,n,r,u,c);
 ...
 function on(t,e,i,n,r,a,o,s){
  ...
  var d=dn(l.textStroke||n.textStroke,p),f=fn(l.textFill||n.textFill),p=D(l.textStrokeWidth,n.textStrokeWidth);
 ...
 function ur(t,e,i,n,r,a){
  ...
  if(or(u)&&or(c)) if(or(s)) a[0]=0; else{
   ...
   if(or(g)){
    ...
    var w=(2*u*s-3*o*c)/(2*ym(u*u*u)),b=Math.acos(w)/3,S=ym(u),M=Math.cos(b),p=(-s-2*S*M)/(3*o),m=(-s+S*(M+wm*Math.sin(b)))/(3*o),I=(-s+S*(M-wm*Math.sin(b)))/(3*o);
 ...
 function Sr(t,e,i,n,r,a,o,s){
  var l=mr,h=pr,u=Cm(Tm(l(t,i,r),1),0),c=Cm(Tm(l(e,n,a),1),0),d=h(t,i,r,u),f=h(e,n,a,c);
  ...
  for(var a=0,o=0,s=0,l=0,h=0,u=0; u<t.length;){
   ...
   switch(c===Km.M&&u>1&&(i||(a+=kr(o,s,l,h,n,r))), 1==u&&(o=t[u], s=t[u+1], l=o, h=s), c){
    ...
    case Km.Q:
     ...
     break;
    case Km.A:
     var d=t[u++],f=t[u++],p=t[u++],g=t[u++],v=t[u++],m=t[u++],y=(t[u++], 1-t[u++]),x=Math.cos(v)*p+d,_=Math.sin(v)*g+f;
 ...
 function Vr(t,e,i,n,r,a,o,s,l,h,u){
  var c=l*(fy/180),d=dy(c)*(t-i)/2+cy(c)*(e-n)/2,f=-1*cy(c)*(t-i)/2+dy(c)*(e-n)/2,p=d*d/(o*o)+f*f/(s*s);
  p>1&&(o*=uy(p), s*=uy(p));
  var g=(r===a?-1:1)*uy((o*o*s*s-o*o*f*f-s*s*d*d)/(o*o*f*f+s*s*d*d))||0,v=g*o*f/s,m=g* -s*d/o,y=(t+i)/2+dy(c)*v-cy(c)*m,x=(e+n)/2+cy(c)*v+dy(c)*m,_=vy([1,0],[(d-v)/o,(f-m)/s]),w=[(d-v)/o,(f-m)/s],b=[(-1*d-v)/o,(-1*f-m)/s],S=vy(w,b);
 ...
 function wa(t,e,i,n,r,a,o){
  r=r||Gy;
  var s,l=r.labelFetcher,h=r.labelDataIndex,u=r.labelDimIndex,c=i.getShallow("show"),d=n.getShallow("show");
 ...
 function Pa(t,e,i,n,r,a){
  ...
  if(o){
   var s=t?"Update":"",l=n.getShallow("animationDuration"+s),h=n.getShallow("animationEasing"+s),u=n.getShallow("animationDelay"+s);
 ...
 function Fa(t,e){
  var i=Vy(t.x,e.x),n=Wy(t.x+t.width,e.x+e.width),r=Vy(t.y,e.y),a=Wy(t.y+t.height,e.y+e.height);
 ...
 function xo(t,e,i){
  ...
  var n=ro(e),r=i?"UTC":"",a=n["get"+r+"FullYear"](),o=n["get"+r+"Month"]()+1,s=n["get"+r+"Date"](),l=n["get"+r+"Hours"](),h=n["get"+r+"Minutes"](),u=n["get"+r+"Seconds"](),c=n["get"+r+"Milliseconds"]();
 ...
 function bo(t,e,i){
  i=rx(i||0);
  var n=e.width,r=e.height,a=Ua(t.left,n),o=Ua(t.top,r),s=Ua(t.right,n),l=Ua(t.bottom,r),h=Ua(t.width,n),u=Ua(t.height,r),c=i[2]+i[0],d=i[1]+i[3],f=t.aspect;
 ...
 function Ao(t){
  var e=t.get("coordinateSystem"),i={coordSysName:e,coordSysDims:[],axisMap:N(),categoryAxisMap:N()},n=Mx[e];
 ...
 function zo(t){
  var e=t.option,i=e.data,n=I(i)?kx:Ix,r=!1,a=e.seriesLayoutBy,o=e.sourceHeader,s=e.dimensions,l=Vo(t);
  if(l){
   var h=l.option;
  ...
  !c&&l&&(c=Fo(t,l,i,n,a,u)), Ox(t).source=new ko({
   data:i,fromDataset:r,seriesLayoutBy:a,sourceFormat:n,dimensionsDefine:u.dimensionsDefine,startIndex:u.startIndex,dimensionsDetectCount:u.dimensionsDetectCount,encodeDefine:c
  })
 }
 ...
 function Fo(t,e,i,n,r,a){
  var o=Ao(t),s={},l=[],h=[],u=t.subType,c=N(["pie","map","funnel"]),d=N(["line","bar","pictorialBar","scatter","effectScatter","candlestick","boxplot"]);
  if(o&&null!=d.get(u)){
   var p=t.ecModel,g=Ox(p).datasetMap,v=e.uid+"_"+r,m=g.get(v)||g.set(v,{categoryWayDim:1,valueWayDim:0});
 ...
 function gs(t){
  f(t,function(e,i){
   var n=[],r=[0/0,0/0],a=[e.stackResultDimension,e.stackedOverDimension],o=e.data,s=e.isStackedByIndex,l=o.map(a,function(a,l,h){
 ...
 function Ws(t){
  var e=t.model,i=t.ecModel,n=t.api,r=t.payload,a=e.pipelineContext.progressiveRender,o=t.view,s=r&&u_(r).updateMethod,l=a?"incrementalPrepareRender":s&&o[s]?s:"render";
 ...
 function gl(t,e,i){
  var n=e/t.width,r=i/t.height,a=Math.min(n,r),o=[a,a],s=[-(t.x+t.width/2)*a+e/2,-(t.y+t.height/2)*a+i/2];
 ...
 function Sl(t,e){
  var i=t.type,n=t.escapeConnect,r=fw[i],a=r.actionInfo,l=(a.update||"update").split(":"),h=l.pop();
 ...
 function kh(t,e,i){
  ...
  return {
   stackedDimension:r&&r.name,stackedByDimension:n&&n.name,isStackedByIndex:s,stackedOverDimension:o,stackResultDimension:a
  }
 }
 function Ph(t,e){
 ...
 function Vh(t,e,i,n){
  ...
  var s=r.intervalPrecision=Wh(o),l=r.niceTickExtent=[Zw(Math.ceil(t[0]/o)*o,s),Zw(Math.floor(t[1]/o)*o,s)];
  return Hh(l,t), r
 }
 function Wh(t){
  return Ja(t)+2
 ...
 function Uh(t){
  var e=[];
  return f(t,function(t){
   var i=t.getData(),n=t.coordinateSystem,r=n.getBaseAxis(),a=r.getExtent(),o="category"===r.type?r.getBandWidth():Math.abs(a[1]-a[0])/i.count(),s=Ua(t.get("barWidth"),o),l=Ua(t.get("barMaxWidth"),o),h=t.get("barGap"),u=t.get("barCategoryGap");
   e.push({
 ...
 function $h(t){
  ...
  return f(e,function(t,e){
   i[e]={};
   var n=t.stacks,r=t.bandWidth,a=Ua(t.categoryGap,r),o=Ua(t.gap,1),s=t.remainedWidth,l=t.autoWidthCount,h=(s-a)/(l+(l-1)*o);
 ...
 function Qh(t,e){
  ...
  f(i,function(t){
   var e=t.getData(),i=t.coordinateSystem,a=i.getBaseAxis(),o=Xh(t),s=n[Yh(a)][o],l=s.offset,h=s.width,u=i.getOtherAxis(a),c=t.get("barMinHeight")||0;
 ...
 function au(t,e){
  ...
  t.setExtent(i[0],i[1]), t.niceExtent({
   splitNumber:a,fixMin:n,fixMax:r,minInterval:"interval"===o||"time"===o?e.get("minInterval"):null,maxInterval:"interval"===o||"time"===o?e.get("maxInterval"):null
  });
 ...
 function cu(t,e){
  var i=e*Math.PI/180,n=t.plain(),r=n.width,a=n.height,o=r*Math.cos(i)+a*Math.sin(i),s=r*Math.sin(i)+a*Math.cos(i),l=new gi(n.x,n.y,o,s);
  return l
 }
 function du(t,e){
  if("image"!==this.type){
 ...
 function Lu(t){
  var e=Ou(t),i=lu(t),n=(e.axisRotate-e.labelRotate)/180*Math.PI,r=t.scale,a=r.getExtent(),o=r.count();
 ...
 function zu(t,e,i){
  ...
  var r=lu(t),a=t.scale,o=a.getExtent(),s=t.getLabelModel(),l=[],h=Math.max((e||0)+1,1),u=o[0],c=a.count();
 ...
 function tc(t,e,i,n,r,a,o,l){
  var h=e.getItemVisual(i,"color"),u=e.getItemVisual(i,"opacity"),c=n.getModel("itemStyle"),d=n.getModel("emphasis.itemStyle").getBarItemStyle();
 ...
 function nc(t,e,i){
  var n=i.getVisual("borderColor")||i.getVisual("color"),r=e.getModel("itemStyle").getItemStyle(["color","borderColor"]);
 ...
 function sc(t,e,i){
  ...
  e=e||[], i=i||[];
  var a=e[0],o=e[1],s=e[e.length-1],l=e[e.length-2],h=i[0],u=i[1],c=i[i.length-1],d=i[i.length-2];
 ...
 function cc(t,e,i){
  ...
  if(e.get("axisTick.show")&& !n.scale.isBlank()){
   for(var r=e.getModel("axisTick"),a=r.getModel("lineStyle"),o=r.get("length"),l=n.getTicksCoords(),h=[],u=[],c=t._transform,d=[],f=0; f<l.length; f++){
    ...
    var g=new ky(ia({
     anid:"tick_"+l[f].tickValue,shape:{x1:h[0],y1:h[1],x2:u[0],y2:u[1]},style:s(a.getLineStyle(),{stroke:e.get("axisLine.lineStyle.color")}),z2:2,silent:!0
    }));
 ...
 function dc(t,e,i){
  ...
  if(r&& !n.scale.isBlank()){
   var a=e.getModel("axisLabel"),o=a.get("margin"),s=n.getViewLabels(),l=(A(i.labelRotate,a.get("rotate"))||0)*Qb/180,h=eS(i.rotation,l,i.labelDirection),u=e.getCategories(!0),c=[],d=oc(e),p=e.get("triggerEvent");
   return f(s,function(r,s){
    ...
    var m=v.getTextColor()||e.get("axisLine.lineStyle.color"),y=n.dataToCoord(l),x=[y,i.labelOffset+i.labelDirection*o],_=new xy({anid:"label_"+l,position:x,rotation:h.rotation,silent:d,z2:10});
    ba(_.style,v,{
     text:f,textAlign:v.getShallow("align",!0)||h.textAlign,textVerticalAlign:v.getShallow("verticalAlign",!0)||v.getShallow("baseline",!0)||h.textVerticalAlign,textFill:"function"== typeof m?m("category"===n.type?g:"value"===n.type?l+"":l,s):m
  ...
  iS(i.getCoordinateSystems(),function(i){
   function s(n,s,l){
    ...
    if(d&&("auto"!==d||n||bc(u))){
     ...
     var f=u.get("snap"),p=Sc(l.model),g=s||f||"category"===l.type,v=t.axesInfo[p]={
      key:p,axis:l,coordSys:i,axisPointerModel:u,triggerTooltip:s,involveSeries:g,snap:f,useHandle:bc(u),seriesModels:[]
     };
   ...
   if(i.axisPointerEnabled){
    ...
    if(iS(i.getAxes(),nS(s,!1,null)), i.getTooltipAxes&&n&&c.get("show")){
     var d="axis"===c.get("trigger"),f="cross"===c.get("axisPointer.type"),p=i.getTooltipAxes(c.get("axisPointer.axis"));
 ...
 function Tc(t,e,i){
  i=i||{};
  var n=t.coordinateSystem,r=e.axis,a={},o=r.getAxesOnZeroOf()[0],s=r.position,l=o?"onZero":s,h=r.dim,u=n.getRect(),c=[u.x,u.x+u.width,u.y,u.y+u.height],d={left:0,right:1,top:0,bottom:1,onZero:2},f=e.get("offset")||0,p="x"===h?[c[2]-f,c[3]+f]:[c[0]-f,c[1]+f];
  if(o){
 ...
 function Nc(t,e,i){
  var n,r=t.getBaseAxis(),a=t.getOtherAxis(r),o=Fc(a,i),s=r.dim,l=a.dim,h=e.mapDimension(l),u=e.mapDimension(s),c="x"===l||"radius"===l?1:0,d=p(t.dimensions,function(t){
   return e.mapDimension(t)
  }),f=e.getCalculationInfo("stackResultDimension");
  return (n|=Ph(e,d[0]))&&(d[0]=f), (n|=Ph(e,d[1]))&&(d[1]=f), {
   dataDimsForPoint:d,valueStart:o,valueAxisDim:l,baseAxisDim:s,stacked:!!n,valueDim:h,baseDim:u,baseDataOffset:c,stackedOverDimension:e.getCalculationInfo("stackedOverDimension")
  }
 }
 function Fc(t,e){
 ...
 function Kc(t,e,i,n){
  var r=Uc(t.getAxis("x")),a=Uc(t.getAxis("y")),o=t.getBaseAxis().isHorizontal(),s=Math.min(r[0],r[1]),l=Math.min(a[0],a[1]),h=Math.max(r[0],r[1])-s,u=Math.max(a[0],a[1])-l;
 ...
 function Qc(t,e,i,n){
  ...
  var h=new Sy({
   shape:{
    cx:$a(t.cx,1),cy:$a(t.cy,1),r0:$a(o[0],1),r:$a(o[1],1),startAngle:-s[0]*l,endAngle:-s[1]*l,clockwise:r.inverse
   }
  });
 ...
 function dd(t,e){
  return p(["Radius","Angle"],function(i,n){
   var r=this["get"+i+"Axis"](),a=e[n],o=t[n]/2,s="dataTo"+i,l="category"===r.type?r.getBandWidth():Math.abs(r[s](a-o)-r[s](a+o));
 ...
 function vd(t,e,i,n){
  ...
  var m,y,x,_,w,b=s({
   getWidth:n.getWidth,getHeight:n.getHeight,getZr:n.getZr,getDevicePixelRatio:n.getDevicePixelRatio,value:a,style:l,styleEmphasis:h,visual:u,barLayout:c,currentSeriesIndices:d,font:f
  },v.api||{}),S={
   context:{},seriesId:t.id,seriesName:t.name,seriesIndex:t.seriesIndex,coordSys:v.coordSys,dataInsideLength:e.count(),encode:md(t.getData())
  },M=!0;
  return function(t,i){
 ...
 function _d(t,e,i,n,r){
  var a=i.children,o=a?a.length:0,s=i.$mergeChildren,l="byName"===s||i.diffChildrenByName,h=s=== !1;
  if(o||l||h){
   if(l) return void wd({
    oldChildren:t.children()||[],newChildren:a||[],dataIndex:e,animatableModel:n,group:t,data:r
   });
   h&&t.removeAll();
 ...
 function Bd(t,e,i,n){
  ...
  if(e.triggerTooltip&&r.length){
   ...
   u||(u=t.map[h]={
    ...
    axisDim:a.dim,axisIndex:o.componentIndex,axisType:o.type,axisId:o.id,value:n,valueLabelOpt:{precision:s.get("label.precision"),formatter:s.get("label.formatter")},seriesDataIndices:r.slice()
   })
  }
 }
 function Nd(t,e,i){
 ...
 function af(t,e,i,n,r){
  ...
  }),s=i.getModel("label"),l=rx(s.get("padding")||0),h=s.getFont(),u=Ei(o,h),c=r.position,d=u.width+l[1]+l[3],f=u.height+l[0]+l[2],p=r.align;
  ...
  v&&"auto"!==v||(v=e.get("axisLine.lineStyle.color")), t.label={
   shape:{
    ...
    text:o,textFont:h,textFill:s.getTextColor(),textPosition:"inside",fill:v,stroke:s.get("borderColor")||"transparent",lineWidth:s.get("borderWidth")||0,shadowBlur:s.get("shadowBlur"),shadowColor:s.get("shadowColor"),shadowOffsetX:s.get("shadowOffsetX"),shadowOffsetY:s.get("shadowOffsetY")
   },z2:10
  }
 }
 function of(t,e,i,n){
 ...
 function vf(t){
  var e=[],i=t.get("transitionDuration"),n=t.get("backgroundColor"),r=t.getModel("textStyle"),a=t.get("padding");
 ...
 function Af(t,e,i,n,r,a){
  var o=[],s=Ph(e,n),l=s?e.getCalculationInfo("stackResultDimension"):n,h=zf(e,l,t),u=e.indicesOfNearest(l,h)[0];
  ...
  if(e||i|| !n.ignore){
   ...
   if(this.__dirty||o.__dirty){
    ...
    if(!n.ignore){
     ...
     n.attr({
      style:{textVerticalAlign:n.__verticalAlign||p,textAlign:n.__textAlign||f},position:d,scale:[r,r]
     })
    }
   }
  }
 ...
 function Jf(t,e,i,n,r){
  var a,o=n.coordinateSystem,s=t.getItemModel(e),l=Ua(s.get("x"),r.getWidth()),h=Ua(s.get("y"),r.getHeight());
  if(isNaN(l)||isNaN(h)){
 ...
 function rp(t,e,i,n,r){
  var a,o=n.coordinateSystem,s=t.getItemModel(e),l=Ua(s.get(i[0]),r.getWidth()),h=Ua(s.get(i[1]),r.getHeight());
  if(isNaN(l)||isNaN(h)){
 ...
 function sp(t){
  var e=t.itemStyle||(t.itemStyle={}),i=e.emphasis||(e.emphasis={}),n=t.label||t.label||{},r=n.normal||(n.normal={}),a={normal:1,emphasis:1};
  f(n,function(t,e){
   a[e]||lp(r,e)||(r[e]=t)
 ...
 function Lp(t){
  var e=Rp("zoomOnMouseWheel",t,this._opt),i=Rp("moveOnMouseWheel",t,this._opt),n=t.wheelDelta,r=Math.abs(n),a=t.offsetX,o=t.offsetY;
  if(0!==n&&(e||i)){
   if(e){
 ...
 function Zp(t){
  ...
  return f(t,function(t){
   ...
   controlType:e,opt:{zoomOnMouseWheel:!0,moveOnMouseMove:!0,moveOnMouseWheel:!0,preventDefaultMouseMove:!!r}
  }
 }
 function Xp(t){
 ...
 },ng=Object.prototype.toString,rg=Array.prototype,ag=rg.forEach,og=rg.filter,sg=rg.slice,lg=rg.map,hg=rg.reduce,ug={},cg=function(){
 ...
 var pg=(Object.freeze||Object)({
  $override:i,clone:n,merge:r,mergeAll:a,extend:o,defaults:s,createCanvas:cg,getContext:l,indexOf:h,inherits:u,mixin:c,isArrayLike:d,each:f,map:p,reduce:g,filter:v,find:m,bind:y,curry:x,isArray:_,isFunction:w,isString:b,isObject:S,isBuiltInObject:M,isTypedArray:I,isDom:T,eqNaN:C,retrieve:A,retrieve2:D,retrieve3:k,slice:P,normalizeCssArray:L,assert:O,trim:z,setAsPrimitive:E,isPrimitive:R,createHashMap:N,concatArray:F,noop:V
 }),gg="undefined"== typeof Float32Array?Array:Float32Array,vg=q,mg=U,yg=ee,xg=ie,_g=(Object.freeze||Object)({
  create:W,copy:G,clone:H,set:Z,add:X,scaleAndAdd:Y,sub:j,len:q,length:vg,lenSquare:U,lengthSquare:mg,mul:$,div:K,dot:Q,scale:J,normalize:te,distance:ee,dist:yg,distanceSquare:ie,distSquare:xg,negate:ne,lerp:re,applyTransform:ae,min:oe,max:se
 });
 le.prototype={
 ...
 var Sg="undefined"!= typeof window&& !!window.addEventListener,Mg=/^(?:mouse|pointer|contextmenu|drag|drop)|click/,Ig=Sg?function(t){
 ...
 var Cg=["click","dblclick","mousewheel","mouseout","mouseup","mousedown","mousemove","contextmenu"],Ag=function(t,e,i,n){
 ...
 zg.updateTransform=function(){
  ...
  if(null!=r&&1!==r){
   ...
   var a=Eg[0]<0?-1:1,o=Eg[1]<0?-1:1,s=((Eg[0]-a)*r+a)/Eg[0]||0,l=((Eg[1]-o)*r+o)/Eg[1]||0;
 ...
 },pv=[["shadowBlur",0],["shadowOffsetX",0],["shadowOffsetY",0],["shadowColor","#000"],["lineCap","butt"],["lineJoin","miter"],["miterLimit",10]],gv=function(t){
  this.extendFrom(t,!1)
 };
 gv.prototype={
  constructor:gv,
 ...
 _v.prototype={
  constructor:_v,__dirty:!0,__used:!1,__drawIndex:0,__startIndex:0,__endIndex:0,incremental:!1,getElementCount:function(){
   ...
   var i=this.dom,n=this.ctx,r=i.width,a=i.height,e=e||this.clearColor,o=this.motionBlur&& !t,s=this.lastFrameAlpha,l=this.dpr;
 ...
 var wv="undefined"!= typeof window&&(window.requestAnimationFrame&&window.requestAnimationFrame.bind(window)||window.msRequestAnimationFrame&&window.msRequestAnimationFrame.bind(window)||window.mozRequestAnimationFrame||window.webkitRequestAnimationFrame)||function(t){
  setTimeout(t,16)
 },bv=new Gg(50),Sv={},Mv=0,Iv=5e3,Tv=/\{([a-zA-Z0-9_]+)\|([^}]*)\}/g,Cv="12px sans-serif",Av={};
 Av.measureText=function(t,e){
  var i=l();
  return i.font=e||Cv, i.measureText(t)
 };
 var Dv={left:1,right:1,center:1},kv={top:1,bottom:1,middle:1},Pv=[["textShadowBlur","shadowBlur",0],["textShadowOffsetX","shadowOffsetX",0],["textShadowOffsetY","shadowOffsetY",0],["textShadowColor","shadowColor","transparent"]],Lv=new gi,Ov=function(){
 };
 Ov.prototype={
  ...
  constructor:mn,type:"displayable",__dirty:!0,invisible:!1,z:0,z2:0,zlevel:0,draggable:!1,dragging:!1,silent:!1,culling:!1,cursor:"pointer",rectHover:!1,progressive:!1,incremental:!1,globalScaleRatio:1,beforeBrush:function(){
  },afterBrush:function(){
  },brush:function(){
 ...
 var zv=1e5,Ev=314159,Rv=.01,Bv=.001,Nv=new gi(0,0,0,0),Fv=new gi(0,0,0,0),Vv=function(t,e,i){
  this.type="canvas";
 ...
 Vv.prototype={
  constructor:Vv,getType:function(){
   ...
   for(var o=!0,s=0; s<i.length; s++){
    var a=i[s],l=a.ctx,h={};
    l.save();
    var u=e?a.__startIndex:a.__drawIndex,c=!e&&a.incremental&&Date.now,d=c&&Date.now(),p=a.zlevel===this._zlevelList[0]?this._backgroundColor:null;
 ...
 },Zv=300,Xv=["click","dblclick","mousewheel","mouseout","mouseup","mousedown","mousemove","contextmenu"],Yv=["touchstart","touchend","touchmove"],jv={pointerdown:1,pointerup:1,pointermove:1,pointerout:1},qv=p(Xv,function(t){
 ...
 },fm=dm([["lineWidth","width"],["stroke","color"],["opacity"],["shadowBlur"],["shadowOffsetX"],["shadowOffsetY"],["shadowColor"]]),pm={
 ...
 },gm=dm([["fill","color"],["shadowBlur"],["shadowOffsetX"],["shadowOffsetY"],["opacity"],["shadowColor"]]),vm={
  getAreaStyle:function(t,e){
   return gm(this,t,e)
  }
 },mm=Math.pow,ym=Math.sqrt,xm=1e-8,_m=1e-4,wm=ym(3),bm=1/3,Sm=W(),Mm=W(),Im=W(),Tm=Math.min,Cm=Math.max,Am=Math.sin,Dm=Math.cos,km=2*Math.PI,Pm=W(),Lm=W(),Om=W(),zm=[],Em=[],Rm={M:1,L:2,C:3,Q:4,A:5,Z:6,R:7},Bm=[],Nm=[],Fm=[],Vm=[],Wm=Math.min,Gm=Math.max,Hm=Math.cos,Zm=Math.sin,Xm=Math.sqrt,Ym=Math.abs,jm="undefined"!= typeof Float32Array,qm=function(t){
  this._saveData= !t, this._saveData&&(this.data=[]), this._ctx=null
 };
 qm.prototype={
  constructor:qm,_xi:0,_yi:0,_x0:0,_y0:0,_ux:0,_uy:0,_len:0,_lineDash:null,_dashOffset:0,_dashIdx:0,_dashSum:0,setScale:function(t,e){
   ...
   var i,n,r=this._dashSum,a=this._dashOffset,o=this._lineDash,s=this._ctx,l=this._xi,h=this._yi,u=t-l,c=e-h,d=Xm(u*u+c*c),f=l,p=h,g=o.length;
   ...
   var o,s,l,h,u,c=this._dashSum,d=this._dashOffset,f=this._lineDash,p=this._ctx,g=this._xi,v=this._yi,m=lr,y=0,x=this._dashIdx,_=f.length,w=0;
   ...
   for(var t=this.data,e=0,i=0,n=0,r=0,a=0; a<t.length;){
    ...
    switch(1==a&&(e=t[a], i=t[a+1], n=e, r=i), o){
     ...
     case Rm.Q:
      ...
      break;
     case Rm.A:
      var s=t[a++],l=t[a++],h=t[a++],u=t[a++],c=t[a++],d=t[a++]+c,f=(t[a++], 1-t[a++]);
   ...
   for(var e,i,n,r,a,o,s=this.data,l=this._ux,h=this._uy,u=this._len,c=0; u>c;){
    ...
    switch(1==c&&(n=s[c], r=s[c+1], e=n, i=r), d){
     ...
     case Rm.Q:
      ...
      break;
     case Rm.A:
      var f=s[c++],p=s[c++],g=s[c++],v=s[c++],m=s[c++],y=s[c++],x=s[c++],_=s[c++],w=g>v?g:v,b=g>v?1:g/v,S=g>v?v/g:1,M=Math.abs(g-v)>.001,I=m+y;
 ...
 var Um=2*Math.PI,$m=2*Math.PI,Km=qm.CMD,Qm=2*Math.PI,Jm=1e-4,ty=[-1,-1,-1],ey=[-1,-1],iy=xv.prototype.getCanvasPattern,ny=Math.abs,ry=new qm(!0);
 Fr.prototype={
  constructor:Fr,type:"path",__dirtyPath:!0,strokeContainThreshold:5,brush:function(t,e){
   var i=this.style,n=this.path||ry,r=i.hasStroke(),a=i.hasFill(),o=i.fill,s=i.stroke,l=a&& !!o.colorStops,h=r&& !!s.colorStops,u=a&& !!o.image,c=r&& !!s.image;
  ...
  for(r=0, a=0; r<l.length;){
   switch(i=l[r++], a=r, n=0, i){
    ...
    case p:
     ...
     break;
    case f:
     var g=e[4],v=e[5],m=sy(e[0]*e[0]+e[1]*e[1]),y=sy(e[2]*e[2]+e[3]*e[3]),x=ly(-e[1]/y,e[0]/m);
 ...
 var _y=Fr.extend({
 ...
 }),wy=[["shadowBlur",0],["shadowColor","#000"],["shadowOffsetX",0],["shadowOffsetY",0]],by=function(t){
  ...
  type:"sector",shape:{cx:0,cy:0,r0:0,r:0,startAngle:0,endAngle:2*Math.PI,clockwise:!0},brush:by(Fr.prototype.brush),buildPath:function(t,e){
 ...
 var Fy=Math.round,Vy=Math.max,Wy=Math.min,Gy={},Hy=Xr,Zy=N(),Xy=0,Yy=(Object.freeze||Object)({
 ...
 },Uy=dm([["fill","color"],["stroke","borderColor"],["lineWidth","borderWidth"],["opacity"],["shadowBlur"],["shadowOffsetX"],["shadowOffsetY"],["shadowColor"],["textPosition"],["textAlign"]]),$y={
 ...
 var Jy=0,tx=1e-4,ex=9007199254740991,ix=/^(?:(\d{4})(?:[-\/](\d{1,2})(?:[-\/](\d{1,2})(?:[T ](\d{1,2})(?::(\d\d)(?::(\d\d)(?:[.,](\d+))?)?)?(Z|[\+\-]\d\d:?\d\d)?)?)?)?)?$/,nx=(Object.freeze||Object)({
  linearMap:qa,parsePercent:Ua,round:$a,asc:Ka,getPrecision:Qa,getPrecisionSafe:Ja,getPixelPrecision:to,getPercentWithPrecision:eo,MAX_SAFE_INTEGER:ex,remRadian:io,isRadianAroundZero:no,parseDate:ro,quantity:ao,nice:so,quantile:lo,reformIntervals:ho,isNumeric:uo
 }),rx=L,ax=/([&<>"'])/g,ox={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},sx=["a","b","c","d","e","f","g"],lx=function(t,e){
  return "{"+t+(null==e?"":e)+"}"
 },hx=Wi,ux=Ei,cx=(Object.freeze||Object)({
  addCommas:co,toCamelCase:fo,normalizeCssArray:rx,encodeHTML:po,formatTpl:go,formatTplSimple:vo,getTooltipMarker:mo,formatTime:xo,capitalFirst:_o,truncateText:hx,getTextRect:ux
 }),dx=f,fx=["left","right","top","bottom","width","height"],px=[["width","left","right"],["height","top","bottom"]],gx=wo,vx=(x(wo,"vertical"), x(wo,"horizontal"), {
  ...
  type:"component",id:"",name:"",mainType:"",subType:"",componentIndex:0,defaultOption:null,ecModel:null,dependentModels:[],uid:null,layoutMode:null,$constructor:function(t,e,i,n){
 ...
 var _x={
  color:["#c23531","#2f4554","#61a0a8","#d48265","#91c7ae","#749f83","#ca8622","#bda29a","#6e7074","#546570","#c4ccd3"],gradientColor:["#f6efa6","#d88273","#bf444c"],textStyle:{
   fontFamily:xx.match(/^Win/)?"Microsoft YaHei":"sans-serif",fontSize:12,fontStyle:"normal",fontWeight:"normal"
  },blendMode:null,animation:"auto",animationDuration:1e3,animationDurationUpdate:300,animationEasing:"exponentialOut",animationEasingUpdate:"cubicOut",animationThreshold:2e3,progressiveThreshold:3e3,progressive:400,hoverLayerThreshold:3e3,useUTC:!1
 },bx=jn(),Sx={
 ...
 },Ix="original",Tx="arrayRows",Cx="objectRows",Ax="keyedColumns",Dx="unknown",kx="typedArray",Px="column",Lx="row";
 ...
 c(Ex,Sx);
 var Rx=["getDom","getZr","getWidth","getHeight","getDevicePixelRatio","dispatchAction","isDisposed","on","off","getDataURL","getConnectedDataURL","getModel","getOption","getViewOfComponentModel","getViewOfSeriesModel"],Bx={};
 Ko.prototype={
 ...
 Qo.prototype={
  constructor:Qo,setOption:function(t,e){
   ...
   var t=this._api.getWidth(),e=this._api.getHeight(),i=this._mediaList,n=this._mediaDefault,r=[],a=[];
 ...
 var Hx=f,Zx=S,Xx=["areaStyle","lineStyle","nodeStyle","linkStyle","chordStyle","label","labelLine"],Yx=function(t,e){
 ...
 },jx=[["x","left"],["y","top"],["x2","right"],["y2","bottom"]],qx=["grid","geo","parallel","legend","toolbox","title","visualMap","dataZoom","timeline"],Ux=function(t,e){
 ...
 var Qx={
  ...
  getDataParams:function(t,e){
   var i=this.getData(e),n=this.getRawValue(t,e),r=i.getRawIndex(t),a=i.getName(t),o=i.getRawDataItem(t),s=i.getItemVisual(t,"color"),l=this.ecModel.getComponent("tooltip"),h=l&&l.get("renderMode"),u=Qn(h),c=this.mainType,d="series"===c;
   return {
    componentType:c,componentSubType:this.subType,componentIndex:this.componentIndex,seriesType:d?this.subType:null,seriesIndex:this.seriesIndex,seriesId:d?this.id:null,seriesName:d?this.name:null,name:a,dataIndex:r,data:o,dataType:e,value:n,color:s,marker:mo({color:s,renderMode:u}),$vars:["seriesName","name","value"]
   }
 ...
 var a_=jn(),o_=yx.extend({
  type:"series.__base__",seriesIndex:0,coordinateSystem:null,defaultOption:null,legendDataProvider:null,visualColorAccessPath:"itemStyle.color",layoutMode:null,init:function(t,e,i){
   ...
   function r(i){
    function r(t,i){
     ...
     if(r&&r.otherDims.tooltip!== !1){
      var d=r.type,f="sub"+o.seriesIndex+"at"+u,p=mo({color:y,type:"subItem",renderMode:n,markerId:f}),g="string"== typeof p?p:p.content,v=(a?g+po(r.displayName||"-")+": ":"")+po("ordinal"===d?t+"":"time"===d?e?"":xo("yyyy/MM/dd hh:mm:ss",t):co(t));
   ...
   var x=p>1||m&& !p?r(v):a(p?Ss(c,t,d[0]):m?v[0]:v),w=x.content,b=o.seriesIndex+"at"+u,M=mo({color:y,type:"item",renderMode:n,markerId:b});
   h[b]=y, ++u;
  ...
  },getAxisTooltipData:null,getTooltipPosition:null,pipeTask:null,preventIncremental:null,pipelineContext:null
 });
 c(o_,i_), c(o_,Sx);
 var s_=function(){
 ...
 var h_=function(){
  var t=jn();
  return function(e){
   var i=t(e),n=e.pipelineContext,r=i.large,a=i.progressiveRender,o=i.large=n.large,s=i.progressiveRender=n.progressiveRender;
 ...
 var f_={
  ...
  toolbox:{
   ...
   },dataView:{title:"数据视图",lang:["数据视图","关闭","刷新"]},dataZoom:{title:{zoom:"区域缩放",back:"区域缩放还原"}},magicType:{title:{line:"切换为折线图",bar:"切换为柱状图",stack:"切换为堆叠",tiled:"切换为平铺"}},restore:{title:"还原"},saveAsImage:{title:"保存为图片",lang:["右键另存为图片"]}
  },series:{
   typeNames:{
  ...
  var i=new Dy({style:{fill:e.maskColor},zlevel:e.zlevel,z:1e4}),n=new Oy({
   shape:{startAngle:-__/2,endAngle:-__/2+.1,r:10},style:{stroke:e.color,lineCap:"round",lineWidth:5},zlevel:e.zlevel,z:10001
  }),r=new Dy({
   style:{
 ...
 b_.restoreData=function(t,e){
  ...
  if(t.__pipeline){
   var i=this._pipelineMap.get(t.__pipeline.id),n=i.context,r=!e&&i.progressiveEnabled&&(!n||n.progressiveRender)&&t.__idxInPipeline>i.blockIndex,a=r?i.step:null,o=n&&n.modDataCount,s=null!=o?Math.ceil(o/a):null;
   return {step:a,modBy:s,modDataCount:o}
  }
 }, b_.getPipeline=function(t){
  return this._pipelineMap.get(t)
 }, b_.updateStreamModes=function(t,e){
  var i=this._pipelineMap.get(t.uid),n=t.getData(),r=n.count(),a=i.progressiveEnabled&&e.incrementalPrepareRender&&r>=i.threshold,o=t.get("large")&&r>=t.get("largeThreshold"),s="mod"===t.get("progressiveChunkMode")?r:null;
 ...
 var A_=["#37A2DA","#32C5E9","#67E0E3","#9FE6B8","#FFDB5C","#ff9f7f","#fb7293","#E062AE","#E690D1","#e7bcf3","#9d96f5","#8378EA","#96BFFF"],D_={
  color:A_,colorLayer:[["#37A2DA","#ffd85c","#fd7b5f"],["#37A2DA","#67E0E3","#FFDB5C","#ff9f7f","#E062AE","#9d96f5"],["#37A2DA","#32C5E9","#9FE6B8","#FFDB5C","#ff9f7f","#fb7293","#e7bcf3","#8378EA","#96BFFF"],A_]
 },k_="#eee",P_=function(){
  return {
   axisLine:{lineStyle:{color:k_}},axisTick:{lineStyle:{color:k_}},axisLabel:{textStyle:{color:k_}},splitLine:{lineStyle:{type:"dashed",color:"#aaa"}},splitArea:{areaStyle:{color:k_}}
  }
 },L_=["#dd6b66","#759aa0","#e69d87","#8dc1a9","#ea7e53","#eedd78","#73a373","#73b9bc","#7289ab","#91ca8c","#f49f42"],O_={
  color:L_,backgroundColor:"#333",tooltip:{axisPointer:{lineStyle:{color:k_},crossStyle:{color:k_}}},legend:{textStyle:{color:k_}},textStyle:{color:k_},title:{textStyle:{color:k_}},toolbox:{iconStyle:{normal:{borderColor:k_}}},dataZoom:{textStyle:{color:k_}},visualMap:{textStyle:{color:k_}},timeline:{
   lineStyle:{color:k_},itemStyle:{normal:{color:L_[1]}},label:{normal:{textStyle:{color:k_}}},controlStyle:{normal:{color:k_,borderColor:k_}}
  },timeAxis:P_(),logAxis:P_(),valueAxis:P_(),categoryAxis:P_(),line:{symbol:"circle"},graph:{color:L_},gauge:{title:{textStyle:{color:k_}}},candlestick:{
   itemStyle:{
    normal:{
 ...
 O_.categoryAxis.splitLine.show= !1, yx.extend({
  type:"dataset",defaultOption:{seriesLayoutBy:Px,sourceHeader:null,dimensions:null,source:null},optionUpdated:function(){
   Po(this)
  }
 ...
 sl.prototype.parse=function(t,e){
  ...
  var n=new lv;
  this._root=n;
  var r=i.getAttribute("viewBox")||"",a=parseFloat(i.getAttribute("width")||e.width),o=parseFloat(i.getAttribute("height")||e.height);
 ...
 var R_={
  ...
  lineargradient:function(t){
   var e=parseInt(t.getAttribute("x1")||0,10),i=parseInt(t.getAttribute("y1")||0,10),n=parseInt(t.getAttribute("x2")||10,10),r=parseInt(t.getAttribute("y2")||0,10),a=new Ry(e,i,n,r);
   return ll(t,a), a
 ...
 },F_=/url\(\s*#(.*?)\)/,V_=/(translate|scale|rotate|skewX|skewY|matrix)\(([\-\s0-9\.e,]*)\)/g,W_=/([^\s:;]+)\s*:\s*([^:;]+)/g,G_=N(),H_={
 ...
 },X_=O,Y_=f,j_=w,q_=S,U_=yx.parseClassType,$_="4.2.0",K_={zrender:"4.0.5"},Q_=1,J_=1e3,tw=5e3,ew=1e3,iw=2e3,nw=3e3,rw=4e3,aw=5e3,ow={
 ...
 var fw={},pw={},gw=[],vw=[],mw=[],yw=[],xw={},_w={},ww={},bw={},Sw=new Date-0,Mw=new Date-0,Iw="_echarts_instance_",Tw=Wl;
 ...
 var Aw=N(["tooltip","label","itemName","itemId","seriesName"]),Dw=S,kw="undefined",Pw="e\x00\x00",Lw={
  "float":typeof Float64Array===kw?Array:Float64Array,"int":typeof Int32Array===kw?Array:Int32Array,ordinal:Array,number:Array,time:Array
 },Ow=typeof Uint32Array===kw?Array:Uint32Array,zw=typeof Uint16Array===kw?Array:Uint16Array,Ew=["hasItemOption","_nameList","_idList","_invertedIndicesMap","_rawData","_chunkSize","_chunkCount","_dimValueGetter","_count","_rawCount","_nameDimIdx","_idDimIdx"],Rw=["_extent","_approximateExtent","_rawExtent"],Bw=function(t,e){
  t=t||["x","y"];
 ...
 var jw="__ec_stack_",qw=.5,Uw="undefined"!= typeof Float32Array?Float32Array:Array,$w={
  seriesType:"bar",plan:h_(),reset:function(t){
   ...
   if(Jh(t)&&tu(t)){
    var i=t.getData(),n=t.coordinateSystem,r=n.getBaseAxis(),a=n.getOtherAxis(r),o=i.mapDimension(a.dim),s=i.mapDimension(r.dim),l=a.isHorizontal(),h=l?0:1,u=Kh(Uh([t]),r,t).width;
    return u>qw||(u=qw), {progress:e}
   }
  }
 },Kw=Yw.prototype,Qw=Math.ceil,Jw=Math.floor,tb=1e3,eb=60*tb,ib=60*eb,nb=24*ib,rb=function(t,e,i,n){
  for(; n>i;){
   var r=i+n>>>1;
   t[r][1]<e?i=r+1:n=r
  }
  ...
  type:"time",getLabel:function(t){
   ...
   var d=this.getSetting("useUTC")?0:60*new Date(+n[0]|| +n[1]).getTimezoneOffset()*1e3,f=[Math.round(Qw((n[0]-d)/h)*h+d),Math.round(Jw((n[1]-d)/h)*h+d)];
 ...
 var sb=Rh.prototype,lb=Yw.prototype,hb=Ja,ub=$a,cb=Math.floor,db=Math.ceil,fb=Math.pow,pb=Math.log,gb=Rh.extend({
 ...
 }),wb={line:ky,rect:Dy,roundRect:Dy,square:Dy,circle:_y,diamond:yb,pin:xb,arrow:_b,triangle:mb},bb={
 ...
 var Mb=$r({
  ...
  createList:pu,getLayoutRect:bo,dataStack:Ib,createScale:gu,mixinAxisModelCommonMethods:vu,completeDimensions:Ch,createDimensions:Vw,createSymbol:fu
 }),Cb=1e-8;
 xu.prototype={
 ...
 var Bb={
  show:!0,zlevel:0,z:0,inverse:!1,name:"",nameLocation:"end",nameRotate:null,nameTruncate:{maxWidth:null,ellipsis:"...",placeholder:"."},nameTextStyle:{},nameGap:15,silent:!1,triggerEvent:!1,tooltip:{show:!1},axisPointer:{},axisLine:{
   show:!0,onZero:!0,onZeroAxisIndex:null,lineStyle:{color:"#333",width:1,type:"solid"},symbol:["none","none"],symbolSize:[10,15]
  },axisTick:{show:!0,inside:!1,length:5,lineStyle:{width:1}},axisLabel:{show:!0,inside:!1,rotate:0,showMinLabel:null,showMaxLabel:null,margin:8,fontSize:12},splitLine:{show:!0,lineStyle:{color:["#ccc"],width:1,type:"solid"}},splitArea:{show:!1,areaStyle:{color:["rgba(250,250,250,0.3)","rgba(200,200,200,0.3)"]}}
 },Nb={};
 Nb.categoryAxis=r({
 ...
 Hb.type="grid", Hb.axisPointerEnabled= !0, Hb.getRect=function(){
  ...
  f(this._axesList,function(t){
   ...
   if(qu(n)){
    ...
    var s=this.getCartesian(a.componentIndex,o.componentIndex),l=n.getData(),h=s.getAxis("x"),u=s.getAxis("y");
 ...
 var Xb=o_.extend({
  type:"series.__base_bar__",getInitialData:function(){
   ...
   if(e){
    var i=e.dataToPoint(e.clampData(t)),n=this.getData(),r=n.getLayout("offset"),a=n.getLayout("size"),o=e.getBaseAxis().isHorizontal()?0:1;
    return i[o]+=r+a/2, i
   }
   return [0/0,0/0]
  },defaultOption:{
 ...
 var Yb=dm([["fill","color"],["stroke","borderColor"],["lineWidth","borderWidth"],["stroke","barBorderColor"],["lineWidth","barBorderWidth"],["opacity"],["shadowBlur"],["shadowOffsetX"],["shadowOffsetY"],["shadowColor"]]),jb={
  ...
  axisLine:function(){
   ...
   if(e.get("axisLine.show")){
    ...
    this.group.add(new ky(ia({
     anid:"line",shape:{x1:r[0],y1:r[1],x2:a[0],y2:a[1]},style:s,strokeContainThreshold:t.strokeContainThreshold||5,silent:!0,z2:1
    })));
    ...
    if("number"== typeof u&&(u=[u,u]), null!=l){
     ...
     f([{rotate:t.rotation+Math.PI/2,offset:u[0],r:0},{
      ...
      if("none"!==l[i]&&null!=l[i]){
       var n=fu(l[i],-c/2,-d/2,c,d,s.stroke,!0),a=e.r+e.offset,o=[r[0]+a*Math.cos(t.rotation),r[1]-a*Math.sin(t.rotation)];
   ...
   if(i){
    var n,r=e.get("nameLocation"),a=t.nameDirection,s=e.getModel("nameTextStyle"),l=e.get("nameGap")||0,h=this.axisModel.axis.getExtent(),u=h[0]>h[1]?-1:1,c=["start"===r?h[0]-u*l:"end"===r?h[1]+u*l:(h[0]+h[1])/2,uc(r)?t.labelOffset+a*l:0],d=e.get("nameRotate");
    null!=d&&(d=d*Qb/180);
    var f;
    ...
    var p=s.getFont(),g=e.get("nameTruncate",!0)||{},v=g.ellipsis,m=A(t.nameTruncateMaxWidth,g.maxWidth,f),y=null!=v&&null!=m?hx(i,m,p,v,{minChar:2,placeholder:g.placeholder}):i,x=e.get("tooltip",!0),_=e.mainType,w={componentType:_,name:i,$vars:["name"]};
    w[_+"Index"]=e.componentIndex;
    var b=new xy({
     anid:"name",__fullText:i,__truncatedText:y,position:c,rotation:n.rotation,silent:oc(e),z2:1,tooltip:x&&x.show?o({
 ...
 var oS=["axisLine","axisTickLabel","axisName"],sS=["splitArea","splitLine"],lS=rS.extend({
  type:"cartesianAxis",axisPointerClass:"CartesianAxisPointer",render:function(t,e,i,n){
   ...
   if(!i.scale.isBlank()){
    ...
    for(var o=e.coordinateSystem.getRect(),l=i.isHorizontal(),h=0,u=i.getTicksCoords({tickModel:n}),c=[],d=[],f=r.getLineStyle(),p=0; p<u.length; p++){
     ...
     this._axisGroup.add(new ky(ia({
      anid:null!=m?"line_"+u[p].tickValue:null,shape:{x1:c[0],y1:c[1],x2:d[0],y2:d[1]},style:s({stroke:a[v]},f),silent:!0
     })))
    }
   }
   ...
   var i=t.axis;
   if(!i.scale.isBlank()){
    var n=t.getModel("splitArea"),r=n.getModel("areaStyle"),a=r.get("color"),o=e.coordinateSystem.getRect(),l=i.getTicksCoords({tickModel:n,clamp:!0});
    if(l.length){
     ...
     for(var f=1; f<l.length; f++){
      ...
      null!=S&&c.set(S,d), this._axisGroup.add(new Dy({
       anid:null!=S?"area_"+S:null,shape:{x:m,y:y,width:x,height:w},style:s({fill:a[d]},v),silent:!0
      })), d=(d+1)%h
     }
 ...
 hS._updateCommon=function(t,e,i,n){
  ...
  var h=n&&n.itemStyle,u=n&&n.hoverItemStyle,c=n&&n.symbolRotate,d=n&&n.symbolOffset,f=n&&n.labelModel,p=n&&n.hoverLabelModel,g=n&&n.hoverAnimation,v=n&&n.cursorStyle;
 ...
 var vS=function(t,e,i,n,r,a,o,s){
  ...
  type:"ec-polyline",shape:{points:[],smooth:0,smoothConstraint:!0,smoothMonotone:null,connectNulls:!1},style:{fill:null,stroke:"#000"},brush:by(Fr.prototype.brush),buildPath:function(t,e){
  ...
  type:"ec-polygon",shape:{
   ...
   var i=e.points,n=e.stackedOnPoints,r=0,a=i.length,o=e.smoothMonotone,s=Yc(i,e.smoothConstraint),l=Yc(n,e.smoothConstraint);
   if(e.connectNulls){
    for(; a>0&&Gc(i[a-1]); a--) ;
    for(; a>r&&Gc(i[r]); r++) ;
   }
  ...
  type:"line",init:function(){
   ...
   if(T=qc(t.get("smooth")), f.setShape({
    ...
    p.useStyle(s(l.getAreaStyle(),{
     ...
     smooth:T,stackedOnSmooth:A,smoothMonotone:t.get("smoothMonotone"),connectNulls:t.get("connectNulls")
    })
   }
   ...
   var o=this._polyline,s=this._polygon,l=t.hostModel,h=vS(this._data,t,this._stackedOnPoints,e,this._coordSys,i,this._valueOrigin,a),u=h.current,c=h.stackedOnCurrent,d=h.next,f=h.stackedOnNext;
  ...
  return {
   seriesType:t,performRawSeries:!0,reset:function(t,n){
    function r(e,i){
     ...
     if(e.hasItemOption){
      var a=e.getItemModel(i),o=a.getShallow("symbol",!0),l=a.getShallow("symbolSize",!0),h=a.getShallow("symbolKeepAspect",!0);
 ...
 zS.updateData=function(t,e,i){
  ...
  var i=this.childAt(1),n=this.childAt(2),r=t.hostModel,a=t.getItemModel(e),o=t.getItemLayout(e),s=o.label,l=t.getItemVisual(e,"color");
  La(i,{shape:{points:s.linePoints||[[s.x,s.y],[s.x,s.y],[s.x,s.y]]}},r,e), La(n,{
   style:{
    x:s.x,y:s.y
   }
  },r,e), n.attr({rotation:s.rotation,origin:[s.x,s.y],z2:10});
  var h=a.getModel("label"),u=a.getModel("emphasis.label"),c=a.getModel("labelLine"),d=a.getModel("emphasis.labelLine"),l=t.getItemVisual(e,"color");
  wa(n.style,n.hoverStyle={},h,u,{
   labelFetcher:t.hostModel,labelDataIndex:e,defaultText:t.getName(e),autoColor:l,useInsideStyle:!!s.inside
  },{
 ...
 var ES=(Bs.extend({
  type:"pie",init:function(){
   ...
   if(!n||n.from!==this.uid){
    var r=t.getData(),a=this._data,o=this.group,s=e.get("animation"),l=!a,h=t.get("animationType"),u=x(rd,this.uid,t,s,i),c=t.get("selectedMode");
    if(r.diff(a).add(function(t){
     ...
     var d=r.getItemLayout(0),f=Math.max(i.getWidth(),i.getHeight())/2,p=y(o.removeClipPath,o);
   ...
   getTargetSeries:function(e){
    ...
    n.each(function(t){
     ...
     if(o) e.setItemVisual(r,"color",o); else{
      var s=e.getItemModel(r),l=s.get("itemStyle.color")||t.getColorFromPalette(e.getName(r)||r+"",t.__paletteScope,e.count());
  ...
  o.each(function(i){
   var n,h,u,c,d=o.getItemLayout(i),f=o.getItemModel(i),p=f.getModel("label"),g=p.get("position")||f.get("emphasis.label.position"),v=f.getModel("labelLine"),m=v.get("length"),y=v.get("length2"),x=(d.startAngle+d.endAngle)/2,_=Math.cos(x),w=Math.sin(x);
   r=d.cx, a=d.cy;
   ...
   var D=p.getFont(),k=p.get("rotate")?0>_?-x+Math.PI:-x:0,P=t.getFormattedLabel(i,"normal")||o.getName(i),L=Ei(P,D,c,"top");
   l= !!k, d.label={
    x:n,y:h,position:g,height:L.height,len:m,len2:y,linePoints:u,textAlign:c,verticalAlign:"middle",rotation:k,inside:b
   }, b||s.push(d.label)
  ...
  e.eachSeriesByType(t,function(t){
   ...
   _(a)||(a=[0,a]), _(r)||(r=[r,r]);
   var o=i.getWidth(),s=i.getHeight(),l=Math.min(o,s),h=Ua(r[0],o),u=Ua(r[1],s),c=Ua(a[0],l/2),d=Ua(a[1],l/2),f=-t.get("startAngle")*FS,p=t.get("minAngle")*FS,g=0;
   e.each(n,function(t){
    !isNaN(t)&&g++
   });
   var v=e.getSum(n),m=Math.PI/(v||g)*2,y=t.get("clockwise"),x=t.get("roseType"),w=t.get("stillShowZeroSum"),b=e.getDataExtent(n);
   b[0]=0;
   var S=NS,M=0,I=f,T=y?1:-1;
   if(e.each(n,function(t,i){
    var n;
    if(isNaN(t)) return void e.setItemLayout(i,{
     angle:0/0,startAngle:0/0,endAngle:0/0,clockwise:y,cx:h,cy:u,r0:c,r:x?0/0:d
    });
 ...
 var GS=function(t){
  ...
  return {
   coordSys:{
    type:"calendar",x:e.x,y:e.y,width:e.width,height:e.height,cellWidth:t.getCellWidth(),cellHeight:t.getCellHeight(),rangeInfo:{start:i.start,end:i.end,weeks:i.weeks,dayCount:i.allDay}
   },api:{
    coord:function(e,i){
 ...
 },jS=["itemStyle"],qS=["emphasis","itemStyle"],US=["label"],$S=["emphasis","label"],KS="e\x00\x00",QS={cartesian2d:GS,geo:HS,singleAxis:ZS,polar:XS,calendar:YS};
 o_.extend({
  type:"series.custom",dependencies:["grid","polar","geo","singleAxis","calendar"],defaultOption:{coordinateSystem:"cartesian2d",zlevel:0,z:2,legendHoverLink:!0,useTransform:!0},getInitialData:function(){
   return Oh(this.getSource(),this)
  ...
  type:"title",render:function(t,e,i){
   if(this.group.removeAll(), t.get("show")){
    var n=this.group,r=t.getModel("textStyle"),a=t.getModel("subtextStyle"),o=t.get("textAlign"),s=t.get("textBaseline"),l=new xy({
 ...
 var JS=ih({
  type:"legend.plain",dependencies:["series"],layoutMode:{type:"box",ignoreSize:!0},init:function(t,e,i){
 ...
 var tM=x,eM=f,iM=lv,nM=nh({
  type:"legend.plain",newlineDisabled:!1,init:function(){
   ...
   if(this.resetInner(), t.get("show",!0)){
    ...
    var r=t.getBoxLayoutParams(),a={width:i.getWidth(),height:i.getHeight()},o=t.get("padding"),l=bo(r,a,o),h=this.layoutInner(t,n,l),u=bo(s({width:h.width,height:h.height},r),a,o);
   ...
   i.eachRawSeries(function(t){
    ...
    if(!a.get(u)) if(c){
     ...
     var p=d.getVisual("legendSymbol")||"roundRect",g=d.getVisual("symbol"),v=this._createItem(u,h,l,e,p,g,t,f,o);
     ...
     if(!a.get(u)&&i.legendDataProvider){
      ...
      if(0>c) return;
      var d=r.getItemVisual(c,"color"),f="roundRect",p=this._createItem(u,h,l,e,f,null,t,d,o);
   ...
   var u=n.get("itemWidth"),c=n.get("itemHeight"),d=n.get("inactiveColor"),f=n.get("symbolKeepAspect"),p=n.isSelected(t),g=new iM,v=i.getModel("textStyle"),m=i.get("icon"),y=i.getModel("tooltip"),x=y.parentModel;
   ...
   "string"== typeof S&&S?M=S.replace("{name}",null!=t?t:""):"function"== typeof S&&(M=S(t)), g.add(new xy({
    style:ba({},v,{
     text:M,x:w,y:c/2,textFill:p?v.getTextColor():d,textAlign:b,textVerticalAlign:"middle"
    })
   }));
   var I=new Dy({
 ...
 var aM=JS.extend({
  type:"legend.scroll",setScrollDataIndex:function(t){
   ...
   scrollDataIndex:0,pageButtonItemGap:5,pageButtonGap:null,pageButtonPosition:"end",pageFormatter:"{current}/{total}",pageIcons:{
    horizontal:["M0,0L12,-10L12,10z","M0,0L-12,-10L-12,10z"],vertical:["M0,0L20,0L10,-20z","M0,0L20,0L10,20z"]
   },pageIconColor:"#2f4554",pageIconInactiveColor:"#aaa",pageIconSize:15,pageTextStyle:{color:"#333"},animationDurationUpdate:800
  },init:function(t,e,i,n){
   var r=Mo(t);
  ...
  type:"legend.scroll",newlineDisabled:!0,init:function(){
   ...
   function r(t,i){
    var r=t+"DataIndex",l=Va(e.get("pageIcons",!0)[e.getOrient().name][i],{onclick:y(a._pageGo,a,r,e,n)},{
   ...
   var n=this.getContentGroup(),r=this._containerGroup,a=this._controllerGroup,o=t.getOrient().index,s=sM[o],l=sM[1-o],h=lM[1-o];
   ...
   var i,n,r,a,o=t.get("scrollDataIndex",!0),s=this.getContentGroup(),l=s.getBoundingRect(),h=this._containerGroup.__rectSize,u=t.getOrient().index,c=sM[u],d=sM[1-u],f=lM[u],p=s.position.slice();
 ...
 var uM=function(t,e){
  ...
  var n=t.currTrigger,r=[t.x,t.y],a=t,o=t.dispatchAction||y(i.dispatchAction,i),s=e.getComponent("axisPointer").coordSysAxesInfo;
  if(s){
   Hd(r)&&(r=uM({seriesIndex:a.seriesIndex,dataIndex:a.dataIndex},e).point);
   var l=Hd(r),h=a.axesInfo,u=s.axesInfo,c="leave"===n||Hd(r),d={},f={},p={list:[],map:{}},g={showPointer:dM(Rd,f),showTooltip:dM(Bd,p)};
  ...
  type:"axisPointer",coordSysAxesInfo:null,defaultOption:{
   show:"auto",triggerOn:null,zlevel:0,z:50,type:"line",snap:!1,triggerTooltip:!0,value:null,status:null,link:[],animation:null,animationDurationUpdate:200,lineStyle:{color:"#aaa",width:1,type:"solid"},shadowStyle:{color:"rgba(150,150,150,0.3)"},label:{
 ...
 Kd.prototype={
  _group:null,_lastGraphicKey:null,_handle:null,_dragging:!1,_lastValue:null,_lastStatus:null,_payloadInfo:null,animationThreshold:15,render:function(t,e,i,n){
   ...
   if(!this._dragging&&this.updateHandleTransform){
    var e=this._axisPointerModel,i=this._api.getZr(),n=this._handle,r=e.getModel("handle"),a=e.get("status");
    if(!r.get("show")|| !a||"hide"===a) return n&&i.remove(n), void (this._handle=null);
    var o;
    this._handle||(o= !0, n=this._handle=Va(r.get("icon"),{
     cursor:"move",draggable:!0,onmousemove:function(t){
      Ig(t.event)
     },onmousedown:_M(this._onHandleDragMove,this,0,0),drift:_M(this._onHandleDragMove,this),ondragend:_M(this._onHandleDragEnd,this)
    }), i.add(n)), nf(n,e,!1);
   ...
   if(t){
    ...
    this._api.dispatchAction({
     type:"updateAxisPointer",x:e.cursorPoint[0],y:e.cursorPoint[1],tooltipOption:e.tooltipOption,axesInfo:[{axisDim:i.axis.dim,axisIndex:i.componentIndex}]
    })
   }
 ...
 var wM=Kd.extend({
  makeElOption:function(t,e,i,n,r){
   var a=i.axis,o=a.grid,s=n.get("type"),l=df(o,a).getOtherAxis(a).getGlobalExtent(),h=a.toGlobalCoord(a.dataToCoord(e,!0));
   if(s&&"none"!==s){
   ...
   var n=i.axis,r=n.grid,a=n.getGlobalExtent(!0),o=df(r,n).getOtherAxis(n).getGlobalExtent(),s="x"===n.dim?0:1,l=t.position;
 ...
 rS.registerAxisPointerClass("CartesianAxisPointer",wM), Yl(function(t){
  ...
  type:"tooltip",dependencies:["axisPointer"],defaultOption:{
   zlevel:0,z:60,show:!0,showContent:!0,trigger:"item",triggerOn:"mousemove|click",alwaysShowContent:!1,displayMode:"single",renderMode:"auto",confine:!1,showDelay:0,hideDelay:100,transitionDuration:.4,enterable:!1,backgroundColor:"rgba(50,50,50,0.7)",borderColor:"#333",borderRadius:4,borderWidth:0,padding:5,extraCssText:"",axisPointer:{
    type:"line",axis:"auto",animation:"auto",animationDurationUpdate:200,animationEasingUpdate:"exponentialOut",crossStyle:{color:"#999",width:1,type:"dashed",textStyle:{}}
   },textStyle:{color:"#fff",fontSize:14}
  }
 });
 var SM=f,MM=fo,IM=["","-webkit-","-moz-","-o-"],TM="position:absolute;display:block;border-style:solid;white-space:nowrap;z-index:9999999;";
 mf.prototype={
 ...
 nh({
  type:"tooltip",init:function(t,e){
   ...
   var i=this._ecModel,n=this._tooltipModel,a=[e.offsetX,e.offsetY],o=[],s=[],l=xf([e.tooltipOption,n]),h=this._renderMode,u=this._newLine,c={};
   AM(t,function(t){
    AM(t.dataByAxis,function(t){
     ...
     if(e&&null!=n){
      ...
      f(t.seriesDataIndices,function(o){
       var u=i.getSeriesByIndex(o.seriesIndex),d=o.dataIndexInside,f=u&&u.getDataParams(d);
   ...
   var n=this._ecModel,r=e.seriesIndex,a=n.getSeriesByIndex(r),o=e.dataModel||a,s=e.dataIndex,l=e.dataType,h=o.getData(),u=xf([h.getItemModel(s),o,a&&(a.coordinateSystem||{}).model,this._tooltipModel]),c=u.get("trigger");
   if(null==c||"item"===c){
 ...
 var PM=co,LM=po,OM=ih({
  type:"marker",dependencies:["series","grid","polar","geo"],init:function(t,e,i,n){
   ...
   var e=this.getData(),i=this.getRawValue(t),n=_(i)?p(i,PM).join(", "):PM(i),r=e.getName(t),a=LM(this.name);
 ...
 BM.extend({
  type:"markPoint",updateTransform:function(t,e,i){
   ...
   var r=t.coordinateSystem,a=t.id,o=t.getData(),s=this.markerGroupMap,l=s.get(a)||s.set(a,new zc),h=Rf(r,t,e);
   e.setData(h), Ef(e.getData(),t,n), h.each(function(t){
    ...
    "function"== typeof n&&(n=n(e.getRawValue(t),e.getDataParams(t))), h.setItemVisual(t,{
     symbolSize:n,color:i.get("itemStyle.color")||o.getVisual("color"),symbol:i.getShallow("symbol")
    })
 ...
 GM.beforeUpdate=Gf, GM._createLine=function(t,e,i){
  ...
  var n=t.hostModel,r=this.childOfName("line"),a=i&&i.lineStyle,o=i&&i.hoverLineStyle,l=i&&i.labelModel,h=i&&i.hoverLabelModel;
  ...
  (null!=_||null!=w)&&(ba(y.style,l,{text:_},{autoColor:p}), y.__textAlign=b.textAlign, y.__verticalAlign=b.textVerticalAlign, y.__position=l.get("position")||"middle"), y.hoverStyle=null!=w?{
   text:w,textFill:h.getTextColor(!0),fontStyle:h.getShallow("fontStyle"),fontWeight:h.getShallow("fontWeight"),fontSize:h.getShallow("fontSize"),fontFamily:h.getShallow("fontFamily")
  ...
  type:"markLine",updateTransform:function(t,e,i){
   ...
   function r(e,i,r){
    ...
    Jf(e,i,r,t,n), e.setItemVisual(i,{
     symbolSize:a.get("symbolSize")||g[r?0:1],symbol:a.get("symbol",!0)||p[r?0:1],color:a.get("itemStyle.color")||s.getVisual("color")
    })
   }
   var a=t.coordinateSystem,o=t.id,s=t.getData(),l=this.markerGroupMap,h=l.get(o)||l.set(o,new Zf);
 ...
 BM.extend({
  type:"markArea",updateTransform:function(t,e,i){
   ...
   var r=t.coordinateSystem,a=t.id,o=t.getData(),l=this.markerGroupMap,h=l.get(a)||l.set(a,{group:new lv});
   ...
   e.setData(u), u.each(function(e){
    ...
    var n=u.getItemModel(i),r=n.getModel("label"),a=n.getModel("emphasis.label"),o=u.getItemVisual(i,"color");
 ...
 var qM=yx.extend({
  type:"timeline",layoutMode:"box",defaultOption:{
   ...
   var o={category:"ordinal",time:"time"}[i]||"number",s=this._data=new Bw([{name:"value",type:o}],this);
   s.initData(e,r)
  },getData:function(){
   return this._data
  ...
  type:"timeline.slider",defaultOption:{
   backgroundColor:"rgba(0,0,0,0)",borderColor:"#ccc",borderWidth:0,orient:"horizontal",inverse:!1,tooltip:{trigger:"item"},symbol:"emptyCircle",symbolSize:10,lineStyle:{show:!0,width:2,color:"#304654"},label:{position:"auto",show:!0,interval:"auto",rotate:0,color:"#304654"},itemStyle:{color:"#304654",borderWidth:1},checkpointStyle:{
    ...
    label:{show:!0,color:"#c23531"},itemStyle:{color:"#c23531"},controlStyle:{color:"#c23531",borderColor:"#c23531",borderWidth:2}
   },data:[]
  }
 });
 c(UM,i_);
 ...
 $M.extend({
  type:"timeline.slider",init:function(t,e){
   ...
   var a={horizontal:"center",vertical:i>=0||"+"===i?"left":"right"},o={horizontal:i>=0||"+"===i?"top":"bottom",vertical:"middle"},s={horizontal:0,vertical:tI/2},l="vertical"===n?r.height:r.width,h=t.getModel("controlStyle"),u=h.get("show",!0),c=u?h.get("itemSize"):0,d=u?h.get("itemGap"):0,f=c+d,p=t.get("label.rotate")||0;
   p=p*tI/180;
   var g,v,m,y,x=h.get("position",!0),_=u&&h.get("showPlayBtn",!0),w=u&&h.get("showPrevBtn",!0),b=u&&h.get("showNextBtn",!0),S=0,M=l;
   return "left"===x||"bottom"===x?(_&&(g=[0,0], S+=f), w&&(v=[S,0], S+=f), b&&(m=[M-c,0], M-=f)):(_&&(g=[M-c,0], M-=f), w&&(v=[0,0], S+=f), b&&(m=[M-c,0], M-=f)), y=[S,M], t.get("inverse")&&y.reverse(), {
    viewRect:r,mainLength:l,orient:n,rotation:s[n],labelRotation:p,labelPosOpt:i,labelAlign:t.get("label.align")||a[n],labelBaseline:t.get("label.verticalAlign")||t.get("label.baseline")||o[n],playPosition:g,prevBtnPosition:v,nextBtnPosition:m,axisExtent:y,controlSize:c,controlGap:d
   }
   ...
   n.get("lineStyle.show")&&e.add(new ky({
    shape:{x1:r[0],y1:0,x2:r[1],y2:0},style:o({lineCap:"round"},n.getModel("lineStyle").getLineStyle()),silent:!0,z2:1
   }))
  },_renderAxisTick:function(t,e,i,n){
   var r=n.getData(),a=i.scale.getTicks();
   JM(a,function(t){
    var a=i.dataToCoord(t),o=r.getItemModel(t),s=o.getModel("itemStyle"),l=o.getModel("emphasis.itemStyle"),h={position:[a,0],onclick:QM(this._changeTimeline,this,t)},u=cp(o,s,e,h);
   ...
   if(r.get("show")){
    ...
    JM(o,function(n){
     var r=n.tickValue,o=a.getItemModel(r),s=o.getModel("label"),l=o.getModel("emphasis.label"),h=i.dataToCoord(n.tickValue),u=new xy({
      position:[h,0],rotation:t.labelRotation-t.rotation,onclick:QM(this._changeTimeline,this,r),silent:!1
     });
     ba(u.style,s,{
   ...
   var a=t.controlSize,o=t.rotation,s=n.getModel("controlStyle").getItemStyle(),l=n.getModel("emphasis.controlStyle").getItemStyle(),h=[0,-a/2,a,a],u=n.getPlayState(),c=n.get("inverse",!0);
   ...
   var r=n.getData(),a=n.getCurrentIndex(),o=r.getItemModel(a).getModel("checkpointStyle"),s=this,l={
    onCreate:function(t){
 ...
 var eI=["x","y","z","radius","angle","single"],iI=["cartesian2d","polar","singleAxis"],nI=pp(eI,["axisIndex","axis","index","id"]),rI=f,aI=Ka,oI=function(t,e,i,n){
 ...
 oI.prototype={
  constructor:oI,hostedBy:function(t){
   ...
   var e=this._dataExtent,i=this.getAxisModel(),n=i.axis.scale,r=this._dataZoomModel.getRangePropMode(),a=[0,100],o=[t.start,t.end],s=[];
 ...
 var sI=f,lI=nI,hI=ih({
  type:"dataZoom",dependencies:["xAxis","yAxis","zAxis","radiusAxis","angleAxis","singleAxis","series"],defaultOption:{
   ...
   this.eachTargetAxis(function(e,i,n,r){
    var a=this.dependentModels[e.axis][i],o=a.__dzAxisProxy||(a.__dzAxisProxy=new oI(e.name,i,this,r));
    t[e.name+"_"+i]=o
   },this)
   ...
   t&&lI(function(e){
    ...
    this._isSeriesHasAllAxesTypeOf(t,"value")&&lI(function(e){
     var n=i[e.axisIndex],r=t.get(e.axisIndex),a=t.get(e.axisId),o=t.ecModel.queryComponents({mainType:e.axis,index:r,id:a})[0];
  ...
  type:"dataZoom.slider",layoutMode:"box",defaultOption:{
   show:!0,right:"ph",top:"ph",width:"ph",height:"ph",left:null,bottom:null,backgroundColor:"rgba(47,69,84,0)",dataBackground:{
    lineStyle:{color:"#2f4554",width:.5,opacity:.3},areaStyle:{color:"rgba(47,69,84,0.3)",opacity:.3}
   },borderColor:"#ddd",fillerColor:"rgba(167,183,204,0.4)",handleIcon:"M8.2,13.6V3.9H6.3v9.7H3.1v14.9h3.3v9.7h1.8v-9.7h3.3V13.6H8.2z M9.7,24.4H4.8v-1.4h4.9V24.4z M9.7,19.1H4.8v-1.4h4.9V19.1z",handleSize:"100%",handleStyle:{color:"#a7b7cc"},labelPrecision:null,labelFormatter:null,showDetail:!0,showDataShadow:"auto",realtime:!0,zoomLock:!1,textStyle:{color:"#333"}
  }
 ...
 }),dI=Dy,fI=qa,pI=Ka,gI=y,vI=f,mI=7,yI=1,xI=30,_I="horizontal",wI="vertical",bI=5,SI=["line","bar","candlestick","scatter"],MI=uI.extend({
  type:"dataZoom.slider",init:function(t,e){
   ...
   var t=this.dataZoomModel,e=this.api,i=this._findCoordRect(),n={width:e.getWidth(),height:e.getHeight()},r=this._orient===_I?{
   ...
   i.add(new dI({
    silent:!0,shape:{x:0,y:0,width:e[0],height:e[1]},style:{fill:t.get("backgroundColor")},z2:-40
   })), i.add(new dI({
    shape:{x:0,y:0,width:e[0],height:e[1]},style:{fill:"transparent"},z2:0,onclick:y(this._onClickPanelClick,this)
   }))
  },_renderDataShadow:function(){
   var t=this._dataShadowInfo=this._prepareDataShadowInfo();
   if(t){
    var e=this._size,i=t.series,n=i.getRawData(),r=i.getShadowDim?i.getShadowDim():t.otherDim;
    if(null!=r){
     var a=n.getDataExtent(r),o=.3*(a[1]-a[0]);
     a=[a[0]-o,a[1]+o];
     var l,h=[0,e[1]],u=[0,e[0]],c=[[e[0],0],[0,0]],d=[],f=u[1]/(n.count()-1),p=0,g=Math.round(n.count()/e[0]);
     ...
     this._displayables.barGroup.add(new Cy({
      shape:{points:c},style:s({fill:v.get("dataBackgroundColor")},v.getModel("dataBackground.areaStyle").getAreaStyle()),silent:!0,z2:-20
     })), this._displayables.barGroup.add(new Ay({
      shape:{points:d},style:v.getModel("dataBackground.lineStyle").getLineStyle(),silent:!0,z2:-19
     }))
    }
   }
   ...
   n.add(t.filler=new dI({
    draggable:!0,cursor:Ip(this._orient),drift:gI(this._onDragMove,this,"all"),onmousemove:function(t){
     Ig(t.event)
    },ondragstart:gI(this._showDataInfo,this,!0),ondragend:gI(this._onDragEnd,this),onmouseover:gI(this._showDataInfo,this,!0),onmouseout:gI(this._showDataInfo,this,!1),style:{fill:a.get("fillerColor"),textPosition:"inside"}
   })), n.add(new dI(na({
    ...
    var r=Va(a.get("handleIcon"),{
     cursor:Ip(this._orient),draggable:!0,drift:gI(this._onDragMove,this,t),onmousemove:function(t){
      Ig(t.event)
     },ondragend:gI(this._onDragEnd,this),onmouseover:gI(this._showDataInfo,this,!0),onmouseout:gI(this._showDataInfo,this,!1)
   ...
   var i=this.dataZoomModel,n=this._handleEnds,r=this._getViewExtent(),a=i.findRepresentativeAxisProxy().getMinMaxSpan(),o=[0,100];
   ...
   function e(t){
    var e=za(n.handles[t].parent,this.group),i=Ra(0===t?"right":"left",e),s=this._handleWidth/2+bI,l=Ea([c[t]+(0===t?-s:s),this._size[1]/2],e);
    r[t].setStyle({
     x:l[0],y:l[1],textVerticalAlign:a===_I?"middle":i,textAlign:a===_I?i:"center",text:o[t]
    })
   }
   ...
   if(i.get("showDetail")){
    ...
    if(s){
     var l=s.getAxisModel().axis,h=this._range,u=t?s.calculateDataWindow({start:h[0],end:h[1]}).valueWindow:s.getDataValueWindow();
   ...
   this._dragging= !0;
   var n=this._displayables.barGroup.getLocalTransform(),r=Ea([e,i],n,!0),a=this._updateInterval(t,r[0]),o=this.dataZoomModel.get("realtime");
 ...
 var TI="\x00_ec_dataZoom_roams",CI=y,AI=uI.extend({
  ...
  zoom:function(t,e,i,n){
   ...
   if(o){
    var s=kI[e](null,[n.originX,n.originY],o,i,t),l=(s.signal>0?s.pixelStart+s.pixelLength-s.pixel:s.pixel-s.pixelStart)/s.pixelLength*(a[1]-a[0])+a[0],h=Math.max(1/n.scale,0);
  ...
  grid:function(t,e,i,n,r){
   ...
   var a=i.axis,o={},s=r.model.coordinateSystem,l=s.getRadiusAxis().getExtent(),h=s.getAngleAxis().getExtent();
 ...
 var PI,LI="urn:schemas-microsoft-com:vml",OI="undefined"== typeof window?null:window,zI=!1,EI=OI&&OI.document;
 ...
 if(!tg.canvasSupported){
  var ZI=",",XI="progid:DXImageTransform.Microsoft",YI=21600,jI=YI/2,qI=1e5,UI=1e3,$I=function(t){
   ...
   for(a=0; g>a;){
    switch(r=p[a++], n="", i=0, r){
     ...
     case c:
      ...
      a++;
      var O=p[a++],z=C+WI(P)*D,E=A+GI(P)*k,y=C+WI(L)*D,x=A+GI(L)*k,R=O?" wa ":" at ";
  ...
  yn.prototype.brushVML=function(t){
   ...
   if(r){
    var h=n.x||0,u=n.y||0,c=n.width,d=n.height,f=n.sWidth,p=n.sHeight,g=n.sx||0,v=n.sy||0,m=f&&p,y=this._vmlEl;
  ...
  var cT,dT="normal",fT={},pT=0,gT=100,vT=document.createElement("div"),mT=function(t){
   ...
   if(!e){
    ...
    e={
     style:n.fontStyle||dT,variant:n.fontVariant||dT,weight:n.fontWeight||dT,size:0|parseFloat(n.fontSize||12),family:i||"Microsoft YaHei"
    }, fT[t]=e, pT++
   }
   return e
  };
  ...
  for(var yT=new gi,xT=function(t,e,i,n){
   ...
   if(null!=a&&(a+=""), a){
    ...
    var c,d,f=r.textAlign,p=r.textVerticalAlign,g=mT(r.font),v=g.style+" "+g.variant+" "+g.weight+" "+g.size+'px "'+g.family+'"';
    i=i||Ei(a,v,f,p);
...
layui.define(function(exports){
 echarts.registerTheme('walden',{
  "color":["#3fb1e3","#6be6c1","#626c91","#a0a7e6","#c4ebad","#96dee8"],"backgroundColor":"rgba(252,252,252,0)","textStyle":{},"title":{
   "textStyle":{
    "color":"#666666"
   },"subtextStyle":{
    "color":"#999999"
   ...
   },"symbolSize":"10","symbol":"emptyCircle","smooth":true
  },"radar":{
   "itemStyle":{
    "normal":{
     "borderWidth":"3"
   ...
   "itemStyle":{
    "normal":{
     "color":"#e6a0d2","color0":"transparent","borderColor":"#e6a0d2","borderColor0":"#3fb1e3","borderWidth":"2"
    }
   }
  },"graph":{
   "itemStyle":{
   ...
   },"symbolSize":"10","symbol":"emptyCircle","smooth":true,"color":["#3fb1e3","#6be6c1","#626c91","#a0a7e6","#c4ebad","#96dee8"],"label":{
    "normal":{
     "textStyle":{
      "color":"#ffffff"
     }
   ...
   "itemStyle":{
    "normal":{
     "areaColor":"#eeeeee","borderColor":"#aaaaaa","borderWidth":0.5
    },"emphasis":{
     "areaColor":"rgba(63,177,227,0.25)","borderColor":"#3fb1e3","borderWidth":1
    }
   },"label":{
    "normal":{
     "textStyle":{
   ...
   "lineStyle":{
    "color":"#626c91","width":1
   },"itemStyle":{
    "normal":{
     "color":"#626c91","borderWidth":1
    },"emphasis":{
     "color":"#626c91"
    }
   },"controlStyle":{
    "normal":{
     "color":"#626c91","borderColor":"#626c91","borderWidth":0.5
    },"emphasis":{
     "color":"#626c91","borderColor":"#626c91","borderWidth":0.5
    }
   },"checkpointStyle":{
    "color":"#3fb1e3","borderColor":"rgba(63,177,227,0.15)"
   },"label":{
    "normal":{
     "textStyle":{
      "color":"#626c91"
   ...
   "backgroundColor":"rgba(255,255,255,0)","dataBackgroundColor":"rgba(222,222,222,1)","fillerColor":"rgba(114,230,212,0.25)","handleColor":"#cccccc","handleSize":"100%","textStyle":{
    "color":"#999999"
   }
  },"markPoint":{
   "label":{
